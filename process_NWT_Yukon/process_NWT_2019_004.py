...
wkdir = '/mnt/data/users/herringtont/soil_temp/In-Situ/NWT/2019-004/'
odir = '/mnt/data/users/herringtont/soil_temp/In-Situ/NWT/2019-004/site_level/'
pathlist = os.listdir(wkdir)
pathlist_sorted = natural_sort(pathlist)

master_site_cntr = 1183
for path in pathlist_sorted:
    ...
    print(master_site_cntr,'NWT_2019_004',latitude[0],longitude[0],sit_nam)
