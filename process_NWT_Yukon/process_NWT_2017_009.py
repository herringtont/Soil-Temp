...
wkdir = '/mnt/data/users/herringtont/soil_temp/In-Situ/NWT/2017-009/'
odir = '/mnt/data/users/herringtont/soil_temp/In-Situ/NWT/2017-009/site_level/'
pathlist = os.listdir(wkdir)
pathlist_sorted = natural_sort(pathlist)

master_site_cntr = 896
