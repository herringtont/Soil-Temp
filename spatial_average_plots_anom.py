...
################### grab data for each site to plot ######################
    				...
    				L1fil = "".join(["/mnt/data/users/herringtont/soil_temp/plots/spatial_average_anom/"+str(remap_type)+"/"+olri+"/"+lyrj+"/thr_"+thrk+"/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_grid"+str(min_grid)+"_grid"+str(max_grid)+"_anom.png"])
    				print(L1fil)
    				plt.savefig(L1fil)
    				plt.close()
