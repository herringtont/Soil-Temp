...
#Grid_Single = plt.scatter(x,y,20,marker='s', color='Yellow') ## plot single-site grid cells as yellow squares
...
plt.tight_layout()
plt_name = ''.join(["/mnt/data/users/herringtont/soil_temp/plots/Site_Locations/subsets/Site_Locations_Subsets_L5_sites.png"])
print(plt_name)
