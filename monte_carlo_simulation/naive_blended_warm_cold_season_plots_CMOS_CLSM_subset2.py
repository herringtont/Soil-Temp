...
######### Extract Eurasian and North American/Greenland Grid Cells ##########
    					...
    					#for x in grid_cell_NAG_uq_cold:
    						#dframe_grid_level = dframe_cold_NAG[dframe_cold_NAG['Grid Cell'] == x]
    						#lat_NAG_cold = dframe_grid_level['Central Lat'].iloc[0]
    						#lon_NAG_cold = dframe_grid_level['Central Lon'].iloc[0]
    						#print(x,str(lat_NAG_cold),str(lon_NAG_cold))
...
############## Perform Monte-Carlo Simulation on Data (extracting subsample of Eurasian Sites) ####################
    					...
    					for dd in range(0,1000):
    						dataset_master.append("ERA5")
    					for ee in range(0,1000):
    					...
    					for nn in range(0,1000):
    						dataset_master.append("ERA5-Land")
    					for oo in range(0,1000):
    						dataset_master.append("JRA55")
    					for pp in range(0,1000):
    						dataset_master.append("MERRA2")
    					for qq in range(0,1000):
    						dataset_master.append("GLDAS-Noah")
    					for rr in range(0,1000):
    						dataset_master.append("GLDAS-CLSM")
    					...
    					for x in range(0,1000): #perform 1000 iterations
