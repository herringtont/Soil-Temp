    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				for n in temp_thr:
    					...
    					scatter_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_ERA5_'+str(temp_thr_n)+'_CMOS_CLSM_subset_permafrost.csv'])
...
##### Calculate Metrics Over Entire Dataset ######
    					...
    					dframe_cold = dframe_cold[dframe_cold['RS 2002 Permafrost'] != 'none']
    					#print(dframe_cold)
    					dframe_warm = dframe_warm[dframe_warm['RS 2002 Permafrost'] != 'none']
    					#print(dframe_warm)
#### Cold Season ####
...
## Pearson Correlations ##
    					...
    					dict_all = {"Bias Cold Season": pd.Series([naive_all_bias_cold_all,CFSR_bias_cold_all,ERAI_bias_cold_all,ERA5_bias_cold_all,ERA5_Land_bias_cold_all,JRA_bias_cold_all,MERRA2_bias_cold_all,GLDAS_bias_cold_all,GLDAS_CLSM_bias_cold_all], 
					index=["Naive Blend All","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"Bias Warm Season": pd.Series([naive_all_bias_warm_all, CFSR_bias_warm_all,ERAI_bias_warm_all,ERA5_bias_warm_all,ERA5_Land_bias_warm_all,JRA_bias_warm_all,MERRA2_bias_warm_all,GLDAS_bias_warm_all,GLDAS_CLSM_bias_warm_all], 
					index=["Naive Blend All","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"SDEV Cold Season":pd.Series([naive_all_sdev_cold_all,CFSR_sdev_cold_all,ERAI_sdev_cold_all,ERA5_sdev_cold_all,ERA5_Land_sdev_cold_all,JRA_sdev_cold_all,MERRA2_sdev_cold_all,GLDAS_sdev_cold_all,GLDAS_CLSM_sdev_cold_all], 
					index=["Naive Blend All","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"SDEV Warm Season":pd.Series([naive_all_sdev_warm_all,CFSR_sdev_warm_all,ERAI_sdev_warm_all,ERA5_sdev_warm_all,ERA5_Land_sdev_warm_all,JRA_sdev_warm_all,MERRA2_sdev_warm_all,GLDAS_sdev_warm_all,GLDAS_CLSM_sdev_warm_all], 
					index=["Naive Blend All","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"RMSE Cold Season": pd.Series([naive_all_rmse_cold_all,CFSR_rmse_cold_all,ERAI_rmse_cold_all,ERA5_rmse_cold_all,ERA5_Land_rmse_cold_all,JRA_rmse_cold_all,MERRA2_rmse_cold_all,GLDAS_rmse_cold_all,GLDAS_CLSM_rmse_cold_all], 
					index=["Naive Blend All","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"RMSE Warm Season": pd.Series([naive_all_rmse_warm_all,CFSR_rmse_warm_all,ERAI_rmse_warm_all,ERA5_rmse_warm_all,ERA5_Land_rmse_warm_all,JRA_rmse_warm_all,MERRA2_rmse_warm_all,GLDAS_rmse_warm_all,GLDAS_CLSM_rmse_warm_all], 
					index=["Naive Blend All","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"Pearson Correlation Cold Season": pd.Series([naive_all_corr_cold_all,CFSR_corr_cold_all,ERAI_corr_cold_all,ERA5_corr_cold_all,ERA5_Land_corr_cold_all,JRA_corr_cold_all,MERRA2_corr_cold_all,GLDAS_corr_cold_all,GLDAS_CLSM_corr_cold_all],
					index=["Naive Blend All","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"Pearson Correlation Warm Season": pd.Series([naive_all_corr_warm_all,CFSR_corr_warm_all,ERAI_corr_warm_all,ERA5_corr_warm_all,ERA5_Land_corr_warm_all,JRA_corr_warm_all,MERRA2_corr_warm_all,GLDAS_corr_warm_all,GLDAS_CLSM_corr_warm_all],
					index=["Naive Blend All","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"])}
...
############## Perform Monte-Carlo Simulation on Data (extracting subsample of Eurasian Sites) ####################
    					...
    					for x in range(0,10000): #perform 10000 iterations
    						...
    						gcell_subset_master.append(subset_Eur_gcell_cold)
...
####### Create Master Dataframes #######
    					...
    					gcell_subset_master = [i for sub in gcell_subset_master for i in sub]

    					Counts = Counter(gcell_subset_master)
    					print(Counts)  
...
## Create Plot ##
    					...
    					bias_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/monte_carlo_boxplots/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_bias_monte_carlo_permafrost.png'])
...
## Create Plot ##
    					...
    					sdev_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/monte_carlo_boxplots/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_sdev_monte_carlo_permafrost.png'])
    					...
    					ax_sdev.set_ylim(0,15)
    					ax_sdev.set_yticks(np.arange(0,15 + 1, 1))
    					...
    					ax_sdev_sctr_cold.set_yticks(np.arange(0,15 + 1, 1))
    					...
    					ax_sdev_sctr_warm.set_yticks(np.arange(0,15 + 1, 1))
...
## Create Plot ##
    					...
    					rmse_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/monte_carlo_boxplots/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_rmse_monte_carlo_permafrost.png'])
    					...
    					ax_rmse.set_yticks(np.arange(0,20 + 1, 1))
    					...
    					ax_rmse_sctr_cold.set_ylim(0,20)
    					...
    					ax_rmse_sctr_warm.set_ylim(0,20)
    					ax_rmse_sctr_warm.set_yticks(np.arange(0,20 + 1, 1))
...
## Create Plot ##
    					...
    					corr_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/monte_carlo_boxplots/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_corr_monte_carlo_permafrost.png'])
