    	...
    	for k in olr:
    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				for n in temp_thr:
    					temp_thr_n = n
    					cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021.csv'])
    					warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021.csv'])    			
...
######### Extract Eurasian and North American/Greenland Grid Cells ##########
    					...
    					#grid_cell_NAG_uq_cold = np.delete(grid_cell_NAG_uq_cold, np.where(grid_cell_NAG_uq_cold == 33777))
    					grid_cell_NAG_uq_cold = grid_cell_NAG_uq_cold.tolist()
    					len_gc_NAG_cold = len(grid_cell_NAG_uq_cold)
    					print("Number of N American Grid Cells (Cold):",len_gc_NAG_cold)
    					...
    					#grid_cell_Eur_uq_cold = np.delete(grid_cell_Eur_uq_cold, np.where(grid_cell_Eur_uq_cold == 33777))
    					grid_cell_Eur_uq_cold = grid_cell_Eur_uq_cold.tolist()
    					len_gc_Eur_cold = len(grid_cell_Eur_uq_cold)
    					print("Number of Eurasian Grid Cells (Cold) :",len_gc_Eur_cold)
    					...
    					#grid_cell_NAG_uq_warm = np.delete(grid_cell_NAG_uq_warm, np.where(grid_cell_NAG_uq_warm == 33777))
    					grid_cell_NAG_uq_warm = grid_cell_NAG_uq_warm.tolist()
    					len_gc_NAG_warm = len(grid_cell_NAG_uq_warm)
    					print("Number of N American Grid Cells (Warm):",len_gc_NAG_warm)
    					...
    					#grid_cell_Eur_uq_warm = np.delete(grid_cell_Eur_uq_warm, np.where(grid_cell_Eur_uq_warm == 33777))
    					grid_cell_Eur_uq_warm = grid_cell_Eur_uq_warm.tolist()
    					len_gc_Eur_warm = len(grid_cell_Eur_uq_warm)
    					print("Number of Eurasian Grid Cells (Warm):",len_gc_Eur_warm)
...
## Create Plot ##
    					...
    					sdev_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/monte_carlo_boxplots/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_sdev_monte_carlo_BEST_Sep2021.png'])
...
## Create Plot ##
    					...
    					rmse_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/monte_carlo_boxplots/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_rmse_monte_carlo_BEST_Sep2021_permafrost_newJRA.png'])
...
## Create Plot ##
    					...
    					corr_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/monte_carlo_boxplots/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_corr_monte_carlo_BEST_Sep2021_permafrost_newJRA.png'])
