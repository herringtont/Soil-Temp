...
##### Create Final Dataframe ####
					...
					index=["CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"])}
    					...
    					metrics_model_combo = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_naive_metrics_new_data_CMOS_CLSM_Model_Combos_gcell_BEST_Sep2021_newJRA.csv'])
					...
					index=["1 Model","2 Model","3 Model","4 Model","5 Model","6 Model","7 Model","8 Model"])}
    					...
    					metrics_model_number = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_naive_metrics_new_data_CMOS_CLSM_Model_Number_gcell_BEST_Sep2021_newJRA.csv'])					
