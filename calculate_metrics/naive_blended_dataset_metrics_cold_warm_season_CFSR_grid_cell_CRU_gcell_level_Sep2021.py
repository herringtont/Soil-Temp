...
## Grab Data ## 
    					fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_CRU_Sep2021_airtemp_CFSR.csv'])
...
########## Save CSV Files #########
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_EnsMean_by_grid_cell_CRU_cold_season_Sep2021.csv'])  					
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_CFSR_by_grid_cell_CRU_cold_season_Sep2021.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_ERAI_by_grid_cell_CRU_cold_season_Sep2021.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_ERA5_by_grid_cell_CRU_cold_season_Sep2021.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_ERA5_Land_by_grid_cell_CRU_cold_season_Sep2021.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_JRA55_by_grid_cell_CRU_cold_season_Sep2021.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_MERRA2_by_grid_cell_CRU_cold_season_Sep2021.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_GLDAS_by_grid_cell_CRU_cold_season_Sep2021.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					dframe_cold_final['Lat'] = lat_cold_master
    					dframe_cold_final['Lon'] = lon_cold_master
    					dframe_cold_final['Bias'] = GLDAS_CFSR_bias_cold_master
    					dframe_cold_final['RMSE'] = GLDAS_CFSR_rmse_cold_master
    					dframe_cold_final['Correlation'] = GLDAS_CFSR_corr_cold_master
    					dframe_cold_final['Norm Std'] = GLDAS_CFSR_std_cold_master

    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_GLDAS_CFSR_by_grid_cell_CRU_cold_season_Sep2021.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_EnsMean_by_grid_cell_CRU_warm_season_Sep2021.csv'])  					
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_CFSR_by_grid_cell_CRU_warm_season_Sep2021.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_ERAI_by_grid_cell_CRU_warm_season_Sep2021.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_ERA5_by_grid_cell_CRU_warm_season_Sep2021.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_ERA5_Land_by_grid_cell_CRU_warm_season_Sep2021.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_JRA55_by_grid_cell_CRU_warm_season_Sep2021.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_MERRA2_by_grid_cell_CRU_warm_season_Sep2021.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_GLDAS_by_grid_cell_CRU_warm_season_Sep2021.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					dframe_warm_final['Lat'] = lat_warm_master
    					dframe_warm_final['Lon'] = lon_warm_master
    					dframe_warm_final['Bias'] = GLDAS_CFSR_bias_warm_master
    					dframe_warm_final['RMSE'] = GLDAS_CFSR_rmse_warm_master
    					dframe_warm_final['Correlation'] = GLDAS_CFSR_corr_warm_master
    					dframe_warm_final['Norm Std'] = GLDAS_CFSR_std_warm_master

    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CFSR_GLDAS_CFSR_by_grid_cell_CRU_warm_season_Sep2021.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
...
product = ['CFSR','ERA5','ERA5_Land','GLDAS','EnsMean']
########## Create Plots ###########
