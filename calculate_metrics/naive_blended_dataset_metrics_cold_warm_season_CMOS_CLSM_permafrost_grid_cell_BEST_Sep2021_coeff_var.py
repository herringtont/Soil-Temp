...
## Master Arrays ##
    					...
    					stn_mean_cold_master = []
    					naive_mean_cold_master = []
    					naive_noJRA_mean_cold_master = []
    					naive_noJRAold_mean_cold_master = []
    					naive_all_mean_cold_master = []
    					CFSR_mean_cold_master = []
    					ERAI_mean_cold_master = []
    					ERA5_mean_cold_master = []
    					ERA5_Land_mean_cold_master = []
    					JRA_mean_cold_master = []
    					MERRA2_mean_cold_master = []
    					GLDAS_mean_cold_master = []
    					GLDAS_CLSM_mean_cold_master = []

    					stn_CV_cold_master = []
    					naive_CV_cold_master = []
    					naive_noJRA_CV_cold_master = []
    					naive_noJRAold_CV_cold_master = []
    					naive_all_CV_cold_master = []
    					CFSR_CV_cold_master = []
    					ERAI_CV_cold_master = []
    					ERA5_CV_cold_master = []
    					ERA5_Land_CV_cold_master = []
    					JRA_CV_cold_master = []
    					MERRA2_CV_cold_master = []
    					GLDAS_CV_cold_master = []
    					GLDAS_CLSM_CV_cold_master = []
...
## Mean ##
    						...
    						stn_mean_cold =  np.mean(station_temp_cold)
    						stn_mean_cold_master.append(stn_mean_cold)
    						naive_mean_cold = np.mean(naive_temp_cold)
    						naive_mean_cold_master.append(naive_mean_cold)
    						naive_noJRA_mean_cold = np.mean(naive_noJRA_temp_cold)
    						naive_noJRA_mean_cold_master.append(naive_noJRA_mean_cold)
    						naive_noJRAold_mean_cold = np.mean(naive_noJRAold_temp_cold)
    						naive_noJRAold_mean_cold_master.append(naive_noJRAold_mean_cold)
    						naive_all_mean_cold = np.mean(naive_all_temp_cold)
    						naive_all_mean_cold_master.append(naive_all_mean_cold)					
    						CFSR_mean_cold = np.mean(CFSR_temp_cold)
    						CFSR_mean_cold_master.append(CFSR_mean_cold)
    						ERAI_mean_cold = np.mean(ERAI_temp_cold)
    						ERAI_mean_cold_master.append(ERAI_mean_cold)    					
    						ERA5_mean_cold = np.mean(ERA5_temp_cold)
    						ERA5_mean_cold_master.append(ERA5_mean_cold)
    						ERA5_Land_mean_cold = np.mean(ERA5_Land_temp_cold)
    						ERA5_Land_mean_cold_master.append(ERA5_Land_mean_cold)
    						JRA_mean_cold = np.mean(JRA_temp_cold)
    						JRA_mean_cold_master.append(JRA_mean_cold)
    						MERRA2_mean_cold = np.mean(MERRA2_temp_cold)
    						MERRA2_mean_cold_master.append(MERRA2_mean_cold)
    						GLDAS_mean_cold = np.mean(GLDAS_temp_cold)
    						GLDAS_mean_cold_master.append(GLDAS_mean_cold)
    						GLDAS_CLSM_mean_cold = np.mean(GLDAS_CLSM_temp_cold)
    						GLDAS_CLSM_mean_cold_master.append(GLDAS_CLSM_mean_cold)
...
## Coeff of Var ##
    						...
    						naive_std_cold = np.std(naive_temp_cold)
    						naive_noJRA_std_cold = np.std(naive_noJRA_temp_cold)
    						naive_noJRAold_std_cold = np.std(naive_noJRAold_temp_cold)
    						naive_all_std_cold = np.std(naive_all_temp_cold)				
    						CFSR_std_cold = np.std(CFSR_temp_cold)
    						ERAI_std_cold = np.std(ERAI_temp_cold)   					
    						ERA5_std_cold = np.std(ERA5_temp_cold)
    						ERA5_Land_std_cold = np.std(ERA5_Land_temp_cold)
    						JRA_std_cold = np.std(JRA_temp_cold)
    						MERRA2_std_cold = np.std(MERRA2_temp_cold)
    						GLDAS_std_cold = np.std(GLDAS_temp_cold)
    						GLDAS_CLSM_std_cold = np.std(GLDAS_CLSM_temp_cold)
    						...
    						stn_CV_cold = stn_std_cold/stn_mean_cold
    						stn_CV_cold_master.append(stn_CV_cold)
    						naive_CV_cold = naive_std_cold/naive_mean_cold
    						naive_CV_cold_master.append(naive_CV_cold)
    						naive_noJRA_CV_cold = naive_noJRA_std_cold/naive_noJRA_mean_cold
    						naive_noJRA_CV_cold_master.append(naive_noJRA_CV_cold)
    						naive_noJRAold_CV_cold = naive_noJRAold_std_cold/naive_noJRAold_mean_cold
    						naive_noJRAold_CV_cold_master.append(naive_noJRAold_CV_cold)
    						naive_all_CV_cold = naive_all_std_cold/naive_all_mean_cold
    						naive_all_CV_cold_master.append(naive_all_CV_cold)
    						CFSR_CV_cold = CFSR_std_cold/CFSR_mean_cold
    						CFSR_CV_cold_master.append(CFSR_CV_cold)
    						ERAI_CV_cold = ERAI_std_cold/ERAI_mean_cold
    						ERAI_CV_cold_master.append(ERAI_CV_cold)
    						ERA5_CV_cold = ERA5_std_cold/ERA5_mean_cold
    						ERA5_CV_cold_master.append(ERA5_CV_cold)
    						ERA5_Land_CV_cold = ERA5_Land_std_cold/ERA5_Land_mean_cold
    						ERA5_Land_CV_cold_master.append(ERA5_Land_CV_cold)
    						JRA_CV_cold = JRA_std_cold/JRA_mean_cold
    						JRA_CV_cold_master.append(JRA_CV_cold)
    						MERRA2_CV_cold = MERRA2_std_cold/MERRA2_mean_cold
    						MERRA2_CV_cold_master.append(MERRA2_CV_cold)
    						GLDAS_CV_cold = GLDAS_std_cold/GLDAS_mean_cold
    						GLDAS_CV_cold_master.append(GLDAS_CV_cold)
    						GLDAS_CLSM_CV_cold = GLDAS_CLSM_std_cold/GLDAS_CLSM_mean_cold
    						GLDAS_CLSM_CV_cold_master.append(GLDAS_CLSM_CV_cold)
...
## Calculate Average Metrics Across Grid Cells ##
    					...
    					stn_mean_cold_avg = mean(stn_mean_cold_master)
    					naive_mean_cold_avg = mean(naive_mean_cold_master)
    					naive_noJRA_mean_cold_avg = mean(naive_noJRA_mean_cold_master)
    					naive_noJRAold_mean_cold_avg = mean(naive_noJRAold_mean_cold_master)
    					naive_all_mean_cold_avg = mean(naive_all_mean_cold_master)
    					CFSR_mean_cold_avg = mean(CFSR_mean_cold_master)
    					ERAI_mean_cold_avg = mean(ERAI_mean_cold_master)
    					ERA5_mean_cold_avg = mean(ERA5_mean_cold_master)
    					ERA5_Land_mean_cold_avg = mean(ERA5_Land_mean_cold_master)
    					JRA_mean_cold_avg = mean(JRA_mean_cold_master)
    					MERRA2_mean_cold_avg = mean(MERRA2_mean_cold_master)
    					GLDAS_mean_cold_avg = mean(GLDAS_mean_cold_master)
    					GLDAS_CLSM_mean_cold_avg = mean(GLDAS_CLSM_mean_cold_master)
    					...
    					stn_CV_cold_avg = stn_sdev_cold_avg/stn_mean_cold_avg
    					naive_CV_cold_avg = naive_sdev_cold_avg/naive_mean_cold_avg
    					naive_noJRA_CV_cold_avg = naive_noJRA_sdev_cold_avg/naive_noJRA_mean_cold_avg
    					naive_noJRAold_CV_cold_avg = naive_noJRAold_sdev_cold_avg/naive_noJRAold_mean_cold_avg
    					naive_all_CV_cold_avg = naive_all_sdev_cold_avg/naive_all_mean_cold_avg
    					CFSR_CV_cold_avg = CFSR_sdev_cold_avg/CFSR_mean_cold_avg
    					ERAI_CV_cold_avg = ERAI_sdev_cold_avg/ERAI_mean_cold_avg
    					ERA5_CV_cold_avg = ERA5_sdev_cold_avg/ERA5_mean_cold_avg
    					ERA5_Land_CV_cold_avg = ERA5_Land_sdev_cold_avg/ERA5_Land_mean_cold_avg
    					JRA_CV_cold_avg = JRA_sdev_cold_avg/JRA_mean_cold_avg
    					MERRA2_CV_cold_avg = MERRA2_sdev_cold_avg/MERRA2_mean_cold_avg
    					GLDAS_CV_cold_avg = GLDAS_sdev_cold_avg/GLDAS_mean_cold_avg
    					GLDAS_CLSM_CV_cold_avg = GLDAS_CLSM_sdev_cold_avg/GLDAS_CLSM_mean_cold_avg
    					...
    					naive_CV_norm_cold_avg = naive_CV_cold_avg/stn_CV_cold_avg
    					naive_noJRA_CV_norm_cold_avg = naive_noJRA_CV_cold_avg/stn_CV_cold_avg
    					naive_noJRAold_CV_norm_cold_avg = naive_noJRAold_CV_cold_avg/stn_CV_cold_avg
    					naive_all_CV_norm_cold_avg = naive_all_CV_cold_avg/stn_CV_cold_avg
    					CFSR_CV_norm_cold_avg = CFSR_CV_cold_avg/stn_CV_cold_avg
    					ERAI_CV_norm_cold_avg = ERAI_CV_cold_avg/stn_CV_cold_avg
    					ERA5_CV_norm_cold_avg = ERA5_CV_cold_avg/stn_CV_cold_avg
    					ERA5_Land_CV_norm_cold_avg = ERA5_Land_CV_cold_avg/stn_CV_cold_avg
    					JRA_CV_norm_cold_avg = JRA_CV_cold_avg/stn_CV_cold_avg
    					MERRA2_CV_norm_cold_avg = MERRA2_CV_cold_avg/stn_CV_cold_avg
    					GLDAS_CV_norm_cold_avg = GLDAS_CV_cold_avg/stn_CV_cold_avg
    					GLDAS_CLSM_CV_norm_cold_avg = GLDAS_CLSM_CV_cold_avg/stn_CV_cold_avg
...
## Master Arrays ##
    					...
    					stn_mean_warm_master = []
    					naive_mean_warm_master = []
    					naive_noJRA_mean_warm_master = []
    					naive_noJRAold_mean_warm_master = []
    					naive_all_mean_warm_master = []
    					CFSR_mean_warm_master = []
    					ERAI_mean_warm_master = []
    					ERA5_mean_warm_master = []
    					ERA5_Land_mean_warm_master = []
    					JRA_mean_warm_master = []
    					MERRA2_mean_warm_master = []
    					GLDAS_mean_warm_master = []
    					GLDAS_CLSM_mean_warm_master = []

    					stn_CV_warm_master = []
    					naive_CV_warm_master = []
    					naive_noJRA_CV_warm_master = []
    					naive_noJRAold_CV_warm_master = []
    					naive_all_CV_warm_master = []
    					CFSR_CV_warm_master = []
    					ERAI_CV_warm_master = []
    					ERA5_CV_warm_master = []
    					ERA5_Land_CV_warm_master = []
    					JRA_CV_warm_master = []
    					MERRA2_CV_warm_master = []
    					GLDAS_CV_warm_master = []
    					GLDAS_CLSM_CV_warm_master = []
...
## Mean ##
    						...
    						stn_mean_warm =  np.mean(station_temp_warm)
    						stn_mean_warm_master.append(stn_mean_warm)
    						naive_mean_warm = np.mean(naive_temp_warm)
    						naive_mean_warm_master.append(naive_mean_warm)
    						naive_noJRA_mean_warm = np.mean(naive_noJRA_temp_warm)
    						naive_noJRA_mean_warm_master.append(naive_noJRA_mean_warm)
    						naive_noJRAold_mean_warm = np.mean(naive_noJRAold_temp_warm)
    						naive_noJRAold_mean_warm_master.append(naive_noJRAold_mean_warm)
    						naive_all_mean_warm = np.mean(naive_all_temp_warm)
    						naive_all_mean_warm_master.append(naive_all_mean_warm)					
    						CFSR_mean_warm = np.mean(CFSR_temp_warm)
    						CFSR_mean_warm_master.append(CFSR_mean_warm)
    						ERAI_mean_warm = np.mean(ERAI_temp_warm)
    						ERAI_mean_warm_master.append(ERAI_mean_warm)    					
    						ERA5_mean_warm = np.mean(ERA5_temp_warm)
    						ERA5_mean_warm_master.append(ERA5_mean_warm)
    						ERA5_Land_mean_warm = np.mean(ERA5_Land_temp_warm)
    						ERA5_Land_mean_warm_master.append(ERA5_Land_mean_warm)
    						JRA_mean_warm = np.mean(JRA_temp_warm)
    						JRA_mean_warm_master.append(JRA_mean_warm)
    						MERRA2_mean_warm = np.mean(MERRA2_temp_warm)
    						MERRA2_mean_warm_master.append(MERRA2_mean_warm)
    						GLDAS_mean_warm = np.mean(GLDAS_temp_warm)
    						GLDAS_mean_warm_master.append(GLDAS_mean_warm)
    						GLDAS_CLSM_mean_warm = np.mean(GLDAS_CLSM_temp_warm)
    						GLDAS_CLSM_mean_warm_master.append(GLDAS_CLSM_mean_warm)
...
## Coeff of Var ##
    						...
    						naive_std_warm = np.std(naive_temp_warm)
    						naive_noJRA_std_warm = np.std(naive_noJRA_temp_warm)
    						naive_noJRAold_std_warm = np.std(naive_noJRAold_temp_warm)
    						naive_all_std_warm = np.std(naive_all_temp_warm)				
    						CFSR_std_warm = np.std(CFSR_temp_warm)
    						ERAI_std_warm = np.std(ERAI_temp_warm)   					
    						ERA5_std_warm = np.std(ERA5_temp_warm)
    						ERA5_Land_std_warm = np.std(ERA5_Land_temp_warm)
    						JRA_std_warm = np.std(JRA_temp_warm)
    						MERRA2_std_warm = np.std(MERRA2_temp_warm)
    						GLDAS_std_warm = np.std(GLDAS_temp_warm)
    						GLDAS_CLSM_std_warm = np.std(GLDAS_CLSM_temp_warm)
    						...
    						stn_CV_warm = stn_std_warm/stn_mean_warm
    						stn_CV_warm_master.append(stn_CV_warm)
    						naive_CV_warm = naive_std_warm/naive_mean_warm
    						naive_CV_warm_master.append(naive_CV_warm)
    						naive_noJRA_CV_warm = naive_noJRA_std_warm/naive_noJRA_mean_warm
    						naive_noJRA_CV_warm_master.append(naive_noJRA_CV_warm)
    						naive_noJRAold_CV_warm = naive_noJRAold_std_warm/naive_noJRAold_mean_warm
    						naive_noJRAold_CV_warm_master.append(naive_noJRAold_CV_warm)
    						naive_all_CV_warm = naive_all_std_warm/naive_all_mean_warm
    						naive_all_CV_warm_master.append(naive_all_CV_warm)
    						CFSR_CV_warm = CFSR_std_warm/CFSR_mean_warm
    						CFSR_CV_warm_master.append(CFSR_CV_warm)
    						ERAI_CV_warm = ERAI_std_warm/ERAI_mean_warm
    						ERAI_CV_warm_master.append(ERAI_CV_warm)
    						ERA5_CV_warm = ERA5_std_warm/ERA5_mean_warm
    						ERA5_CV_warm_master.append(ERA5_CV_warm)
    						ERA5_Land_CV_warm = ERA5_Land_std_warm/ERA5_Land_mean_warm
    						ERA5_Land_CV_warm_master.append(ERA5_Land_CV_warm)
    						JRA_CV_warm = JRA_std_warm/JRA_mean_warm
    						JRA_CV_warm_master.append(JRA_CV_warm)
    						MERRA2_CV_warm = MERRA2_std_warm/MERRA2_mean_warm
    						MERRA2_CV_warm_master.append(MERRA2_CV_warm)
    						GLDAS_CV_warm = GLDAS_std_warm/GLDAS_mean_warm
    						GLDAS_CV_warm_master.append(GLDAS_CV_warm)
    						GLDAS_CLSM_CV_warm = GLDAS_CLSM_std_warm/GLDAS_CLSM_mean_warm
    						GLDAS_CLSM_CV_warm_master.append(GLDAS_CLSM_CV_warm)
...
## Calculate Average Metrics Across Grid Cells ##
    					...
    					stn_mean_warm_avg = mean(stn_mean_warm_master)
    					naive_mean_warm_avg = mean(naive_mean_warm_master)
    					naive_noJRA_mean_warm_avg = mean(naive_noJRA_mean_warm_master)
    					naive_noJRAold_mean_warm_avg = mean(naive_noJRAold_mean_warm_master)
    					naive_all_mean_warm_avg = mean(naive_all_mean_warm_master)
    					CFSR_mean_warm_avg = mean(CFSR_mean_warm_master)
    					ERAI_mean_warm_avg = mean(ERAI_mean_warm_master)
    					ERA5_mean_warm_avg = mean(ERA5_mean_warm_master)
    					ERA5_Land_mean_warm_avg = mean(ERA5_Land_mean_warm_master)
    					JRA_mean_warm_avg = mean(JRA_mean_warm_master)
    					MERRA2_mean_warm_avg = mean(MERRA2_mean_warm_master)
    					GLDAS_mean_warm_avg = mean(GLDAS_mean_warm_master)
    					GLDAS_CLSM_mean_warm_avg = mean(GLDAS_CLSM_mean_warm_master)
    					...
    					stn_CV_warm_avg = stn_sdev_warm_avg/stn_mean_warm_avg
    					naive_CV_warm_avg = naive_sdev_warm_avg/naive_mean_warm_avg
    					naive_noJRA_CV_warm_avg = naive_noJRA_sdev_warm_avg/naive_noJRA_mean_warm_avg
    					naive_noJRAold_CV_warm_avg = naive_noJRAold_sdev_warm_avg/naive_noJRAold_mean_warm_avg
    					naive_all_CV_warm_avg = naive_all_sdev_warm_avg/naive_all_mean_warm_avg
    					CFSR_CV_warm_avg = CFSR_sdev_warm_avg/CFSR_mean_warm_avg
    					ERAI_CV_warm_avg = ERAI_sdev_warm_avg/ERAI_mean_warm_avg
    					ERA5_CV_warm_avg = ERA5_sdev_warm_avg/ERA5_mean_warm_avg
    					ERA5_Land_CV_warm_avg = ERA5_Land_sdev_warm_avg/ERA5_Land_mean_warm_avg
    					JRA_CV_warm_avg = JRA_sdev_warm_avg/JRA_mean_warm_avg
    					MERRA2_CV_warm_avg = MERRA2_sdev_warm_avg/MERRA2_mean_warm_avg
    					GLDAS_CV_warm_avg = GLDAS_sdev_warm_avg/GLDAS_mean_warm_avg
    					GLDAS_CLSM_CV_warm_avg = GLDAS_CLSM_sdev_warm_avg/GLDAS_CLSM_mean_warm_avg
    					...
    					naive_CV_norm_warm_avg = naive_CV_warm_avg/stn_CV_warm_avg
    					naive_noJRA_CV_norm_warm_avg = naive_noJRA_CV_warm_avg/stn_CV_warm_avg
    					naive_noJRAold_CV_norm_warm_avg = naive_noJRAold_CV_warm_avg/stn_CV_warm_avg
    					naive_all_CV_norm_warm_avg = naive_all_CV_warm_avg/stn_CV_warm_avg
    					CFSR_CV_norm_warm_avg = CFSR_CV_warm_avg/stn_CV_warm_avg
    					ERAI_CV_norm_warm_avg = ERAI_CV_warm_avg/stn_CV_warm_avg
    					ERA5_CV_norm_warm_avg = ERA5_CV_warm_avg/stn_CV_warm_avg
    					ERA5_Land_CV_norm_warm_avg = ERA5_Land_CV_warm_avg/stn_CV_warm_avg
    					JRA_CV_norm_warm_avg = JRA_CV_warm_avg/stn_CV_warm_avg
    					MERRA2_CV_norm_warm_avg = MERRA2_CV_warm_avg/stn_CV_warm_avg
    					GLDAS_CV_norm_warm_avg = GLDAS_CV_warm_avg/stn_CV_warm_avg
    					GLDAS_CLSM_CV_norm_warm_avg = GLDAS_CLSM_CV_warm_avg/stn_CV_warm_avg
...
## Create Dataframe ##
					...
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"CV Cold Season": pd.Series([naive_CV_cold_avg,naive_noJRAold_CV_cold_avg,naive_all_CV_cold_avg,naive_noJRA_CV_cold_avg,CFSR_CV_cold_avg,ERAI_CV_cold_avg,ERA5_CV_cold_avg,ERA5_Land_CV_cold_avg,JRA_CV_cold_avg,MERRA2_CV_cold_avg,GLDAS_CV_cold_avg,GLDAS_CLSM_CV_cold_avg], 
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"CV Norm Cold Season": pd.Series([naive_CV_norm_cold_avg,naive_noJRAold_CV_norm_cold_avg,naive_all_CV_norm_cold_avg,naive_noJRA_CV_norm_cold_avg,CFSR_CV_norm_cold_avg,ERAI_CV_norm_cold_avg,ERA5_CV_norm_cold_avg,ERA5_Land_CV_norm_cold_avg,JRA_CV_norm_cold_avg,MERRA2_CV_norm_cold_avg,GLDAS_CV_norm_cold_avg,GLDAS_CLSM_CV_norm_cold_avg], 
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"CV Warm Season": pd.Series([naive_CV_warm_avg,naive_noJRAold_CV_warm_avg,naive_all_CV_warm_avg,naive_noJRA_CV_warm_avg,CFSR_CV_warm_avg,ERAI_CV_warm_avg,ERA5_CV_warm_avg,ERA5_Land_CV_warm_avg,JRA_CV_warm_avg,MERRA2_CV_warm_avg,GLDAS_CV_warm_avg,GLDAS_CLSM_CV_warm_avg], 
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"CV Norm Warm Season": pd.Series([naive_CV_norm_warm_avg,naive_noJRAold_CV_norm_warm_avg,naive_all_CV_norm_warm_avg,naive_noJRA_CV_norm_warm_avg,CFSR_CV_norm_warm_avg,ERAI_CV_norm_warm_avg,ERA5_CV_norm_warm_avg,ERA5_Land_CV_norm_warm_avg,JRA_CV_norm_warm_avg,MERRA2_CV_norm_warm_avg,GLDAS_CV_norm_warm_avg,GLDAS_CLSM_CV_norm_warm_avg], 
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					...
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"])}
    					...
    					metrics_all_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_'+str(permafrost_type_o)+'_grid_avg_BEST_Sep2021_newJRA_coeff_var.csv'])  					
