...
#### Cold Season ####
    					...
    					cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_cold_season_temp_master_ERA5_'+str(temp_thr_o)+'.csv'])
...
#### Warm Season ####
    					...
    					warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_warm_season_temp_master_ERA5_'+str(temp_thr_o)+'.csv'])
...
## Create Dataframe ##
    					...
    					dict_all = {"Bias Cold Season": pd.Series([naive_bias_cold,naive_noJRA_bias_cold,CFSR_bias_cold,ERAI_bias_cold,ERA5_bias_cold,ERA5_Land_bias_cold,JRA_bias_cold,MERRA2_bias_cold,GLDAS_bias_cold,GLDAS_CLSM_bias_cold], 
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"Bias Warm Season": pd.Series([naive_bias_warm,naive_noJRA_bias_warm,CFSR_bias_warm,ERAI_bias_warm,ERA5_bias_warm,ERA5_Land_bias_warm,JRA_bias_warm,MERRA2_bias_warm,GLDAS_bias_warm,GLDAS_CLSM_bias_warm], 
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"SDEV Cold Season":pd.Series([naive_sdev_cold,naive_noJRA_sdev_cold,CFSR_sdev_cold,ERAI_sdev_cold,ERA5_sdev_cold,ERA5_Land_sdev_cold,JRA_sdev_cold,MERRA2_sdev_cold,GLDAS_sdev_cold,GLDAS_CLSM_sdev_cold], 
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"Norm SDV Cold Season": pd.Series([naive_SDV_cold,naive_noJRA_SDV_cold,CFSR_SDV_cold,ERAI_SDV_cold,ERA5_SDV_cold,ERA5_Land_SDV_cold,JRA_SDV_cold,MERRA2_SDV_cold,GLDAS_SDV_cold,GLDAS_CLSM_SDV_cold], 
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"SDEV Warm Season":pd.Series([naive_sdev_warm,naive_noJRA_sdev_warm,CFSR_sdev_warm,ERAI_sdev_warm,ERA5_sdev_warm,ERA5_Land_sdev_warm,JRA_sdev_warm,MERRA2_sdev_warm,GLDAS_sdev_warm,GLDAS_CLSM_sdev_warm], 
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"Norm SDV Warm Season": pd.Series([naive_SDV_warm,naive_noJRA_SDV_warm,CFSR_SDV_warm,ERAI_SDV_warm,ERA5_SDV_warm,ERA5_Land_SDV_warm,JRA_SDV_warm,MERRA2_SDV_warm,GLDAS_SDV_warm,GLDAS_CLSM_SDV_warm], 
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"RMSE Cold Season": pd.Series([naive_rmse_cold,naive_noJRA_rmse_cold,CFSR_rmse_cold,ERAI_rmse_cold,ERA5_rmse_cold,ERA5_Land_rmse_cold,JRA_rmse_cold,MERRA2_rmse_cold,GLDAS_rmse_cold,GLDAS_CLSM_rmse_cold], 
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"RMSE Warm Season": pd.Series([naive_rmse_warm,naive_noJRA_rmse_warm,CFSR_rmse_warm,ERAI_rmse_warm,ERA5_rmse_warm,ERA5_Land_rmse_warm,JRA_rmse_warm,MERRA2_rmse_warm,GLDAS_rmse_warm,GLDAS_CLSM_rmse_warm], 
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"ubRMSE Cold Season": pd.Series([naive_ubrmse_cold,naive_noJRA_ubrmse_cold,CFSR_ubrmse_cold,ERAI_ubrmse_cold,ERA5_ubrmse_cold,ERA5_Land_ubrmse_cold,JRA_ubrmse_cold,MERRA2_ubrmse_cold,GLDAS_ubrmse_cold,GLDAS_CLSM_ubrmse_cold], 
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"ubRMSE Warm Season": pd.Series([naive_ubrmse_warm,naive_noJRA_ubrmse_warm,CFSR_ubrmse_warm,ERAI_ubrmse_warm,ERA5_ubrmse_warm,ERA5_Land_ubrmse_warm,JRA_ubrmse_warm,MERRA2_ubrmse_warm,GLDAS_ubrmse_warm,GLDAS_CLSM_ubrmse_warm], 
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"Pearson Correlation Cold Season": pd.Series([naive_corr_cold,naive_noJRA_corr_cold,CFSR_corr_cold,ERAI_corr_cold,ERA5_corr_cold,ERA5_Land_corr_cold,JRA_corr_cold,MERRA2_corr_cold,GLDAS_corr_cold,GLDAS_CLSM_corr_cold],
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"Pearson Correlation Warm Season": pd.Series([naive_corr_warm,naive_noJRA_corr_warm,CFSR_corr_warm,ERAI_corr_warm,ERA5_corr_warm,ERA5_Land_corr_warm,JRA_corr_warm,MERRA2_corr_warm,GLDAS_corr_warm,GLDAS_CLSM_corr_warm],
					index=["Naive Blend","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"])}
    					...
    					metrics_all_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_naive_blended_metrics_cold_warm_all_ERA5_'+str(temp_thr_o)+'_new_data.csv'])  					
