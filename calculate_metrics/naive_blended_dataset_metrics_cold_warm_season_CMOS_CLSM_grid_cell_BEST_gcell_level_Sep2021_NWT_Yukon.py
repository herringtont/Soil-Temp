...
## Grab Data ## 
    					fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021_NWT_Yukon.csv'])
...
## Pearson Correlations ##
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_CFSR_by_grid_cell_BEST_cold_season_Sep2021_NWT_Yukon.csv'])  					
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_ERAI_by_grid_cell_BEST_cold_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_ERA5_by_grid_cell_BEST_cold_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_ERA5_Land_by_grid_cell_BEST_cold_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_JRA55_by_grid_cell_BEST_cold_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_MERRA2_by_grid_cell_BEST_cold_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_GLDAS_by_grid_cell_BEST_cold_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
    					...
    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_GLDAS_CLSM_by_grid_cell_BEST_cold_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_cold_final.to_csv(metrics_cold_fil)
    					print(metrics_cold_fil)
...
########## Save CSV Files #########
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_CFSR_by_grid_cell_BEST_warm_season_Sep2021_NWT_Yukon.csv'])  					
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_ERAI_by_grid_cell_BEST_warm_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_ERA5_by_grid_cell_BEST_warm_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_ERA5_Land_by_grid_cell_BEST_warm_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_JRA55_by_grid_cell_BEST_warm_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_MERRA2_by_grid_cell_BEST_warm_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_GLDAS_by_grid_cell_BEST_warm_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
    					...
    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_metrics_CLSM_GLDAS_CLSM_by_grid_cell_BEST_warm_season_Sep2021_NWT_Yukon.csv'])  					
    					dframe_warm_final.to_csv(metrics_warm_fil)
    					print(metrics_warm_fil)
...
for i in product:
    product_i = i    	
    top_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/remapcon_top_30cm_naive_metrics_CLSM_'+str(product_i)+'_by_grid_cell_BEST_cold_season_Sep2021_NWT_Yukon.csv'])
    top_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/remapcon_top_30cm_naive_metrics_CLSM_'+str(product_i)+'_by_grid_cell_BEST_warm_season_Sep2021_NWT_Yukon.csv'])
    btm_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/remapcon_30cm_300cm_naive_metrics_CLSM_'+str(product_i)+'_by_grid_cell_BEST_cold_season_Sep2021_NWT_Yukon.csv'])
    btm_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/remapcon_30cm_300cm_naive_metrics_CLSM_'+str(product_i)+'_by_grid_cell_BEST_warm_season_Sep2021_NWT_Yukon.csv'])
    ...
    plt.tight_layout()
    plt_nam = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/CLSM_res/Bias_top30_'+str(product_i)+'_cold_Sep2021_NWT_Yukon.png'])
    fig.savefig(plt_nam)
    plt.close()
    ...
    cb.ax.tick_params(labelsize='large')
    plt.tight_layout()
    plt_nam = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/CLSM_res/Bias_top30_'+str(product_i)+'_warm_Sep2021_NWT_Yukon.png'])
    fig.savefig(plt_nam)
    plt.close()
    ...
    cb.ax.tick_params(labelsize='large')
    plt.tight_layout()
    plt_nam = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/CLSM_res/Bias_depth_'+str(product_i)+'_cold_Sep2021_NWT_Yukon.png'])
    fig.savefig(plt_nam)
    plt.close()
    ...
    cb.ax.tick_params(labelsize='large')
    plt.tight_layout()
    plt_nam = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/CLSM_res/Bias_depth_'+str(product_i)+'_warm_Sep2021_NWT_Yukon.png'])
    fig.savefig(plt_nam)
    plt.close()
