...
#
### Grab Data ## 
#    					fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST.csv'])
...
#
#    					metrics_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_blended_metrics_CLSM_MERRA2_by_grid_cell_BEST_cold_season.csv'])  					
#    					dframe_cold_final.to_csv(metrics_cold_fil)
#    					print(metrics_cold_fil)
#
#    					metrics_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_blended_metrics_CLSM_MERRA2_by_grid_cell_BEST_warm_season.csv'])  					
...
for i in product:
    product_i = i    	
    top_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/remapcon_top_30cm_naive_blended_metrics_CLSM_'+str(product_i)+'_by_grid_cell_BEST_cold_season.csv'])
    top_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/remapcon_top_30cm_naive_blended_metrics_CLSM_'+str(product_i)+'_by_grid_cell_BEST_warm_season.csv'])
    btm_cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/remapcon_30cm_300cm_naive_blended_metrics_CLSM_'+str(product_i)+'_by_grid_cell_BEST_cold_season.csv'])
    btm_warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/remapcon_30cm_300cm_naive_blended_metrics_CLSM_'+str(product_i)+'_by_grid_cell_BEST_warm_season.csv'])
    ...
    plt.tight_layout()
    plt_nam = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/CLSM_res/Bias_top30_'+str(product_i)+'_cold.png'])
    fig.savefig(plt_nam)
    plt.close()
    ...
    cb.ax.tick_params(labelsize='large')
    plt.tight_layout()
    plt_nam = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/CLSM_res/Bias_top30_'+str(product_i)+'_warm.png'])
    fig.savefig(plt_nam)
    plt.close()
    ...
    cb.ax.tick_params(labelsize='large')
    plt.tight_layout()
    plt_nam = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/CLSM_res/Bias_depth_'+str(product_i)+'_cold.png'])
    fig.savefig(plt_nam)
    plt.close()
    ...
    cb.ax.tick_params(labelsize='large')
    plt.tight_layout()
    plt_nam = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/CLSM_res/Bias_depth_'+str(product_i)+'_warm.png'])
    fig.savefig(plt_nam)
    plt.close()
