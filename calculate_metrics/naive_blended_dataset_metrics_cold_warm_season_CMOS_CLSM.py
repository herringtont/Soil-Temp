...
#### Overall (both seasons) ####
    					...
    					scatter_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_ERA5_'+str(temp_thr_o)+'_CMOS_CLSM_subset.csv'])

    					dframe_all = pd.read_csv(scatter_fil)

    					print(dframe_all)

    					station_temp_all = dframe_all['Station'].values
    					naive_temp_all = dframe_all['Naive Blend'].values
    					naive_noJRA_temp_all = dframe_all['Naive Blend no JRA55'].values
    					naive_noJRAold_temp_all = dframe_all['Naive Blend no JRA55 Old'].values
    					naive_all_temp_all = dframe_all['Naive Blend All'].values
    					CFSR_temp_all = dframe_all['CFSR'].values
    					ERAI_temp_all = dframe_all['ERA-Interim'].values
    					ERA5_temp_all = dframe_all['ERA5'].values
    					ERA5_Land_temp_all = dframe_all['ERA5-Land'].values
    					JRA_temp_all = dframe_all['JRA55'].values
    					MERRA2_temp_all = dframe_all['MERRA2'].values
    					GLDAS_temp_all = dframe_all['GLDAS-Noah'].values
    					GLDAS_CLSM_temp_all = dframe_all['GLDAS-CLSM'].values

## Bias ##
    					naive_bias_all = bias(naive_temp_all, station_temp_all)
    					naive_noJRA_bias_all = bias(naive_noJRA_temp_all, station_temp_all)
    					naive_noJRAold_bias_all = bias(naive_noJRAold_temp_all, station_temp_all)
    					naive_all_bias_all = bias(naive_all_temp_all, station_temp_all)
    					CFSR_bias_all = bias(CFSR_temp_all, station_temp_all)
    					ERAI_bias_all = bias(ERAI_temp_all, station_temp_all)
    					ERA5_bias_all = bias(ERA5_temp_all, station_temp_all)
    					ERA5_Land_bias_all = bias(ERA5_Land_temp_all, station_temp_all)
    					JRA_bias_all = bias(JRA_temp_all, station_temp_all)
    					MERRA2_bias_all = bias(MERRA2_temp_all, station_temp_all)
    					GLDAS_bias_all = bias(GLDAS_temp_all, station_temp_all)
    					GLDAS_CLSM_bias_all = bias(GLDAS_CLSM_temp_all, station_temp_all)

## STD DEV ##

    					stn_sdev_all =  np.std(station_temp_all)
    					naive_sdev_all = np.std(naive_temp_all)
    					naive_noJRA_sdev_all = np.std(naive_noJRA_temp_all)
    					naive_noJRAold_sdev_all = np.std(naive_noJRAold_temp_all)
    					naive_all_sdev_all = np.std(naive_all_temp_all)					
    					CFSR_sdev_all = np.std(CFSR_temp_all)
    					ERAI_sdev_all = np.std(ERAI_temp_all)    					
    					ERA5_sdev_all = np.std(ERA5_temp_all)
    					ERA5_Land_sdev_all = np.std(ERA5_Land_temp_all)
    					JRA_sdev_all = np.std(JRA_temp_all)
    					MERRA2_sdev_all = np.std(MERRA2_temp_all)
    					GLDAS_sdev_all = np.std(GLDAS_temp_all)
    					GLDAS_CLSM_sdev_all = np.std(GLDAS_CLSM_temp_all)



## Normalized Standard Deviations ##
    					naive_SDV_all = SDVnorm(naive_temp_all, station_temp_all)
    					naive_noJRA_SDV_all = SDVnorm(naive_noJRA_temp_all, station_temp_all)
    					naive_noJRAold_SDV_all = SDVnorm(naive_noJRAold_temp_all, station_temp_all)
    					naive_all_SDV_all = SDVnorm(naive_all_temp_all, station_temp_all)
    					CFSR_SDV_all = SDVnorm(CFSR_temp_all, station_temp_all)
    					ERAI_SDV_all = SDVnorm(ERAI_temp_all, station_temp_all)
    					ERA5_SDV_all = SDVnorm(ERA5_temp_all, station_temp_all)
    					ERA5_Land_SDV_all = SDVnorm(ERA5_Land_temp_all, station_temp_all)
    					JRA_SDV_all = SDVnorm(JRA_temp_all, station_temp_all)
    					MERRA2_SDV_all = SDVnorm(MERRA2_temp_all, station_temp_all)
    					GLDAS_SDV_all = SDVnorm(GLDAS_temp_all, station_temp_all)
    					GLDAS_CLSM_SDV_all = SDVnorm(GLDAS_CLSM_temp_all, station_temp_all)


## RMSE and ubRMSE ##
    					naive_rmse_all = mean_squared_error(station_temp_all,naive_temp_all, squared=False)
    					naive_noJRA_rmse_all = mean_squared_error(station_temp_all,naive_noJRA_temp_all, squared=False)
    					naive_noJRAold_rmse_all = mean_squared_error(station_temp_all,naive_noJRAold_temp_all, squared=False)
    					naive_all_rmse_all = mean_squared_error(station_temp_all,naive_all_temp_all, squared=False)
    					CFSR_rmse_all = mean_squared_error(station_temp_all,CFSR_temp_all, squared=False)
    					ERAI_rmse_all = mean_squared_error(station_temp_all,ERAI_temp_all, squared=False)
    					ERA5_rmse_all = mean_squared_error(station_temp_all,ERA5_temp_all, squared=False)
    					ERA5_Land_rmse_all = mean_squared_error(station_temp_all,ERA5_Land_temp_all, squared=False)
    					JRA_rmse_all = mean_squared_error(station_temp_all,JRA_temp_all, squared=False)
    					MERRA2_rmse_all = mean_squared_error(station_temp_all,MERRA2_temp_all, squared=False)
    					GLDAS_rmse_all = mean_squared_error(station_temp_all,GLDAS_temp_all, squared=False)
    					GLDAS_CLSM_rmse_all = mean_squared_error(station_temp_all,GLDAS_CLSM_temp_all, squared=False)

    					naive_ubrmse_all = ubrmsd(station_temp_all,naive_temp_all)
    					naive_noJRA_ubrmse_all = ubrmsd(station_temp_all,naive_noJRA_temp_all)
    					naive_noJRAold_ubrmse_all = ubrmsd(station_temp_all,naive_noJRAold_temp_all)
    					naive_all_ubrmse_all = ubrmsd(station_temp_all,naive_all_temp_all)
    					CFSR_ubrmse_all = ubrmsd(station_temp_all,CFSR_temp_all)
    					ERAI_ubrmse_all = ubrmsd(station_temp_all,ERAI_temp_all)
    					ERA5_ubrmse_all = ubrmsd(station_temp_all,ERA5_temp_all)
    					ERA5_Land_ubrmse_all = ubrmsd(station_temp_all,ERA5_Land_temp_all)
    					JRA_ubrmse_all = ubrmsd(station_temp_all,JRA_temp_all)
    					MERRA2_ubrmse_all = ubrmsd(station_temp_all,MERRA2_temp_all)
    					GLDAS_ubrmse_all = ubrmsd(station_temp_all,GLDAS_temp_all)
    					GLDAS_CLSM_ubrmse_all = ubrmsd(station_temp_all,GLDAS_CLSM_temp_all)


## Pearson Correlations ##
    					naive_corr_all,_ = pearsonr(naive_temp_all, station_temp_all)
    					naive_noJRA_corr_all,_ = pearsonr(naive_noJRA_temp_all, station_temp_all)
    					naive_noJRAold_corr_all,_ = pearsonr(naive_noJRAold_temp_all, station_temp_all)
    					naive_all_corr_all,_ = pearsonr(naive_all_temp_all, station_temp_all)
    					CFSR_corr_all,_ = pearsonr(CFSR_temp_all, station_temp_all)
    					ERAI_corr_all,_ = pearsonr(ERAI_temp_all, station_temp_all)
    					ERA5_corr_all,_ = pearsonr(ERA5_temp_all, station_temp_all)
    					ERA5_Land_corr_all,_ = pearsonr(ERA5_Land_temp_all, station_temp_all)
    					JRA_corr_all,_ = pearsonr(JRA_temp_all, station_temp_all)
    					MERRA2_corr_all,_ = pearsonr(MERRA2_temp_all, station_temp_all)
    					GLDAS_corr_all,_ = pearsonr(GLDAS_temp_all, station_temp_all)
    					GLDAS_CLSM_corr_all,_ = pearsonr(GLDAS_CLSM_temp_all, station_temp_all)


    					dict_all_season = {"Bias All Seasons": pd.Series([naive_bias_all,naive_noJRAold_bias_all,naive_all_bias_all,naive_noJRA_bias_all,CFSR_bias_all,ERAI_bias_all,ERA5_bias_all,ERA5_Land_bias_all,JRA_bias_all,MERRA2_bias_all,GLDAS_bias_all,GLDAS_CLSM_bias_all], 
					...
					"SDEV All Seasons":pd.Series([naive_sdev_all,naive_noJRAold_sdev_all,naive_all_sdev_all,naive_noJRA_sdev_all,CFSR_sdev_all,ERAI_sdev_all,ERA5_sdev_all,ERA5_Land_sdev_all,JRA_sdev_all,MERRA2_sdev_all,GLDAS_sdev_all,GLDAS_CLSM_sdev_all], 
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"Norm SDV All Seasons": pd.Series([naive_SDV_all,naive_noJRAold_SDV_all,naive_all_SDV_all,naive_noJRA_SDV_all,CFSR_SDV_all,ERAI_SDV_all,ERA5_SDV_all,ERA5_Land_SDV_all,JRA_SDV_all,MERRA2_SDV_all,GLDAS_SDV_all,GLDAS_CLSM_SDV_all], 
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"RMSE All Seasons": pd.Series([naive_rmse_all,naive_noJRAold_rmse_all,naive_all_rmse_all,naive_noJRA_rmse_all,CFSR_rmse_all,ERAI_rmse_all,ERA5_rmse_all,ERA5_Land_rmse_all,JRA_rmse_all,MERRA2_rmse_all,GLDAS_rmse_all,GLDAS_CLSM_rmse_all], 
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"ubRMSE All Seasons": pd.Series([naive_ubrmse_all,naive_noJRAold_ubrmse_all,naive_all_ubrmse_all,naive_noJRA_ubrmse_all,CFSR_ubrmse_all,ERAI_ubrmse_all,ERA5_ubrmse_all,ERA5_Land_ubrmse_all,JRA_ubrmse_all,MERRA2_ubrmse_all,GLDAS_ubrmse_all,GLDAS_CLSM_ubrmse_all], 
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"]),
					"Pearson Correlation All Seasons": pd.Series([naive_corr_all,naive_noJRAold_corr_all,naive_all_corr_all,naive_noJRA_corr_all,CFSR_corr_all,ERAI_corr_all,ERA5_corr_all,ERA5_Land_corr_all,JRA_corr_all,MERRA2_corr_all,GLDAS_corr_all,GLDAS_CLSM_corr_all],
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"])}
    					df_summary_all_season = pd.DataFrame(dict_all_season)

    					metrics_all_season_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_naive_blended_metrics_ERA5_'+str(temp_thr_o)+'_new_data_CMOS_CLSM_AllSeasons.csv'])  					
    					df_summary_all_season.to_csv(metrics_all_season_fil)
    					print(metrics_all_season_fil)

#### Cold Season ####

    					cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_cold_season_temp_master_ERA5_'+str(temp_thr_o)+'_CMOS_CLSM_subset.csv'])
...
#### Warm Season ####
    					...
    					warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_warm_season_temp_master_ERA5_'+str(temp_thr_o)+'_CMOS_CLSM_subset.csv'])
...
## Create Dataframe ##
					...
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"])}
    					...
    					metrics_all_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_naive_blended_metrics_ERA5_'+str(temp_thr_o)+'_new_data_CMOS_CLSM_noGreenland.csv'])  					
