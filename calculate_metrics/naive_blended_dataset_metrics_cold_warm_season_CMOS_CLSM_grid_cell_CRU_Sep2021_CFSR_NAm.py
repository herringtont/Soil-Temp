...
## Create Dataframe ##
					...
					index=["Ensemble Mean","CFSR","ERA5","ERA5-Land","GLDAS-Noah"])}
    					...
    					metrics_all_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CFSR_res/'+str(remap_type)+'_'+str(lyr_l)+'_naive_blended_metrics_CFSR_'+str(permafrost_type_o)+'_grid_averages_CRU_Sep2021_NAm.csv'])  					
