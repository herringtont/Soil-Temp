...
#### Cold Season ####
    					...
    					dframe_cold_season  = dframe_cold_season[dframe_cold_season['Continent'] == 'Eurasia']
...
#### Warm Season ####
    					...
    					dframe_warm_season = dframe_warm_season[dframe_warm_season['Continent'] == 'Eurasia']
...
## Create Dataframe ##
					...
					index=["Naive Blend","Naive Blend no JRA55 Old","Naive Blend All","Naive Blend no JRA55","CFSR","ERA-Interim","ERA5","ERA5-Land","JRA55","MERRA2","GLDAS-Noah","GLDAS-CLSM"])}
    					...
    					metrics_all_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blended_metrics/cold_warm_season/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_naive_blended_metrics_ERA5_'+str(temp_thr_o)+'_new_data_CMOS_CLSM_Eur.csv'])  					
