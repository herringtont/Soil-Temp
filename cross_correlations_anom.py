...
################### calculate cross-correlations ##########################
    			...
    			##### create scatterplots ########
    				...
    				axtext = []
    				axtext.append('Scatterplot of '+str(NameA)+' against '+str(NameB))
    			...
    			splot_fil = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/Scatterplot/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_scatter.png"])
    			print(splot_fil)
    			plt.tight_layout()
...
#
######################## create figures #########################
#    			corr_fil = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/Spearman/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_corr_matrix_Spearman_anom.png"])
#    			print(corr_fil)
