    	...
    	for k in olr:
    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				timeseries_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(lyr_l)+'_thr_100_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST.csv'])
    				...
    				for o in permafrost_type:
    					...
    					summary_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_thr'+str(thr_m)+'_gcell_summary_CLSM_'+str(permafrost_type_o)+'_BEST.csv'])
    					print(summary_fil)
...
for z in permafrost_type:
    ...
    val_stn_fil_top30 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_top_30cm_thr100_gcell_summary_CLSM_'+str(permafrost_type_o)+'_BEST.csv'])
    val_stn_fil_30_300 =''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_30cm_300cm_thr100_gcell_summary_CLSM_'+str(permafrost_type_o)+'_BEST.csv'])
...
######## top 30cm layer #######
    ...
    top30_ofil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/extended_summary/CLSM_res/remapcon_top_30cm_thr100_gcell_extended_summary_'+str(permafrost_type_z)+'_BEST.csv'])
    print(top30_ofil)
    ...
    ofil_30_300 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/extended_summary/CLSM_res/remapcon_30cm_300cm_thr100_gcell_extended_summary_'+str(permafrost_type_z)+'_BEST.csv'])
