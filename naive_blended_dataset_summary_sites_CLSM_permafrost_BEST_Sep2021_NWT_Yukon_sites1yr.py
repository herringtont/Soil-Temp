...
two_year_dir = '/mnt/data/users/herringtont/soil_temp/sites_1yr/CLSM/'
    	...
    	for k in olr:
    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				two_year_fil = ''.join([two_year_dir+'sites_1yr_'+str(olr_k)+'_'+two_year_layer+'_'+str(thr_m)+'.csv'])
    				#print(two_year_fil)
    				...
    				timeseries_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/sites_1yr/'+str(remap_type)+'_'+str(lyr_l)+'_thr_100_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021_NWT_Yukon_sites_1yr.csv'])
    				...
    				for o in permafrost_type:
    					...
    					summary_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_thr'+str(thr_m)+'_gcell_summary_CLSM_'+str(permafrost_type_o)+'_BEST_Sep2021_NWT_Yukon_sites_1yr.csv'])
    					print(summary_fil)
...
for z in permafrost_type:
    ...
    val_stn_fil_top30 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_top_30cm_thr100_gcell_summary_CLSM_'+str(permafrost_type_o)+'_BEST_Sep2021_NWT_Yukon_sites_1yr.csv'])
    val_stn_fil_30_300 =''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_30cm_300cm_thr100_gcell_summary_CLSM_'+str(permafrost_type_o)+'_BEST_Sep2021_NWT_Yukon_sites_1yr.csv'])
    ...
    sites_2yr_fil_top30 = "/mnt/data/users/herringtont/soil_temp/sites_1yr/CLSM/sites_1yr_zscore_top_30cm_100.csv"
    sites_2yr_fil_30_300 = "/mnt/data/users/herringtont/soil_temp/sites_1yr/CLSM/sites_1yr_zscore_30_299.9_100.csv"
...
######## top 30cm layer #######
    	...
    	for sites in sites_2yr_top30:
    		...
    		if (len(dframe_geom_sites_top30) > 0):
    			...
    			if (int(site_i) < 70):
    				...
    				dtst_i = 'Russian'
    			elif (758 <= int(site_i) <= 788):
    				dtst_i = 'Nordicana'
    			elif (789 <= int(site_i) < 896):
    				dtst_i = 'YZ_ibuttons'
    			elif (896 <= int(site_i) < 969):
    				dtst_i = 'NWT_2017_009'
    			elif (969 <= int(site_i) < 1183):
    				dtst_i = 'NWT_2018_009'
    			elif (1183 <= int(site_i) < 1192):
    				dtst_i = 'NWT_2019_004'
    			elif (1192 <= int(site_i) < 1223):
    				dtst_i = 'NWT_2019_017'
    			elif (1223 <= int(site_i) < 1228):
    				dtst_i = 'Street_2016'
    			elif (1228 <= int(site_i) < 1340):
    				dtst_i = 'Yukon'				
    ...
    top30_ofil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/extended_summary/CLSM_res/remapcon_top_30cm_thr100_gcell_extended_summary_'+str(permafrost_type_z)+'_BEST_Sep2021_NWT_Yukon_sites_1yr.csv'])
    print(top30_ofil)
    ...
    ofil_30_300 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/extended_summary/CLSM_res/remapcon_30cm_300cm_thr100_gcell_extended_summary_'+str(permafrost_type_z)+'_BEST_Sep2021_NWT_Yukon_sites_1yr.csv'])
