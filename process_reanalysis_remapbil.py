...
directory = "/mnt/data/users/herringtont/soil_temp/reanalysis/monthly/remap/rename/common_grid/remapbil/common_date/"
...
# read Reanalysis product from filename
    ...
    rnys = nc_f.split("/rename/common_grid/remapbil/common_date/")[1].split(".nc")[0] 
    print(rnys) 
...
#set directory of out files 
    ...
    odir = ["/mnt/data/users/herringtont/soil_temp/reanalysis/monthly/remap/rename/common_grid/remapbil/grid_level/", rnys2,"/"]
    odir2 = "".join(odir)
