...
############# Grab Data ###############
scatter_fil_top = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon_top_30cm_thr_100_dframe_scatterplot_CMOS_CLSM_subset_permafrost_reorder.csv'])
scatter_fil_btm = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon_30cm_300cm_thr_100_dframe_scatterplot_CMOS_CLSM_subset_permafrost_reorder.csv'])
...
permafrost_scatter_top = dframe_scatter_top['RS 2002 Permafrost'].values
...
permafrost_scatter_btm = dframe_scatter_btm['RS 2002 Permafrost'].values
...
permafrost_master.append(permafrost_scatter_top)
permafrost_master.append(permafrost_scatter_btm)
...
scatter1 = sn.PairGrid(dframe_master,hue='Permafrost')

sns.set_context(rc={"axes.labelsize":40}, font_scale=1.0)
sns.set_palette(sns.color_palette('Set2'))
#scatter1.map_upper(scatter_subset, mask=dframe_master['Layer'] == '0cm - 30cm', cmap=plt.get_cmap('Pastel2'))
scatter1.map_upper(scatter_subset, mask=dframe_master['Layer'] == '0cm - 30cm')
#scatter1.map_diag(sns.histplot, legend = False, color=plt.get_cmap('Pastel2'))
...
plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_scatterplots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_thr_100_scatterplot_all_temp_new_data_CMOS_CLSM_by_permafrost_type.png')
plt.close()
