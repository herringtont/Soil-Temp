...
cold_fil_top = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/sites_1yr/remapcon_simple_average_zscore_top_30cm_thr_100_dframe_cold_season_temp_master_BEST_-2C_CMOS_CLSM_subset_permafrost_Sep2021_NWT.csv'])
cold_fil_btm = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/sites_1yr/remapcon_simple_average_zscore_30cm_300cm_thr_100_dframe_cold_season_temp_master_BEST_-2C_CMOS_CLSM_subset_permafrost_Sep2021_NWT.csv'])

warm_fil_top = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/sites_1yr/remapcon_simple_average_zscore_top_30cm_thr_100_dframe_warm_season_temp_master_BEST_-2C_CMOS_CLSM_subset_permafrost_Sep2021_NWT.csv'])
warm_fil_btm = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/sites_1yr/remapcon_simple_average_zscore_30cm_300cm_thr_100_dframe_warm_season_temp_master_BEST_-2C_CMOS_CLSM_subset_permafrost_Sep2021_NWT.csv'])

scatter_fil_top = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/sites_1yr/remapcon_top_30cm_thr_100_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021_NWT_sites_1yr.csv'])
scatter_fil_btm = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/sites_1yr/remapcon_30cm_300cm_thr_100_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021_NWT_sites_1yr.csv'])
...
top_fil = '/mnt/data/users/herringtont/soil_temp/scripts/dframe_top_Sep2021_NWT_sites1yr.csv'
btm_fil = '/mnt/data/users/herringtont/soil_temp/scripts/dframe_btm_Sep2021_NWT_sites1yr.csv'
...
plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_scatterplots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_thr_100_scatterplot_all_temp_new_data_CMOS_CLSM_all_layers_BEST_Sep2021_NWT_sites_1yr.png')
plt.close()
