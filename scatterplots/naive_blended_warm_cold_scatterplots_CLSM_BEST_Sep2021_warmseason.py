...
cold_fil_top = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/sites_1yr/remapcon_simple_average_zscore_top_30cm_thr_100_dframe_cold_season_temp_master_BEST_-2C_CMOS_CLSM_subset_permafrost_Sep2021.csv'])
cold_fil_btm = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/sites_1yr/remapcon_simple_average_zscore_30cm_300cm_thr_100_dframe_cold_season_temp_master_BEST_-2C_CMOS_CLSM_subset_permafrost_Sep2021.csv'])

warm_fil_top = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon_simple_average_zscore_top_30cm_thr_100_dframe_warm_season_temp_master_BEST_-2C_CMOS_CLSM_subset_permafrost_Sep2021.csv'])
warm_fil_btm = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon_simple_average_zscore_30cm_300cm_thr_100_dframe_warm_season_temp_master_BEST_-2C_CMOS_CLSM_subset_permafrost_Sep2021.csv'])

scatter_fil_top = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon_top_30cm_thr_100_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021_airtemp.csv'])
scatter_fil_btm = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon_30cm_300cm_thr_100_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021_airtemp.csv'])


dframe_cold_top = pd.read_csv(scatter_fil_top)
dframe_cold_top = dframe_cold_top[dframe_cold_top['Season']  == 'Cold']
dframe_cold_top = dframe_cold_top[(dframe_cold_top['RS 2002 Permafrost'] == 'continuous') | (dframe_cold_top['RS 2002 Permafrost'] == 'discontinuous')]
...
dframe_cold_btm = dframe_cold_btm[(dframe_cold_btm['RS 2002 Permafrost'] == 'continuous') | (dframe_cold_btm['RS 2002 Permafrost'] == 'discontinuous')]
...
dframe_warm_top = dframe_warm_top[(dframe_warm_top['RS 2002 Permafrost'] == 'continuous') | (dframe_warm_top['RS 2002 Permafrost'] == 'discontinuous')]
...
dframe_warm_btm = dframe_warm_btm[(dframe_warm_btm['RS 2002 Permafrost'] == 'continuous') | (dframe_warm_btm['RS 2002 Permafrost'] == 'discontinuous')]
...
dframe_scatter_top = dframe_scatter_top[dframe_scatter_top['Season']  == 'Warm']
dframe_scatter_top = dframe_scatter_top[(dframe_scatter_top['RS 2002 Permafrost'] == 'continuous') | (dframe_scatter_top['RS 2002 Permafrost'] == 'discontinuous')]
...
dframe_scatter_btm = dframe_scatter_btm[dframe_scatter_btm['Season']  == 'Warm']
dframe_scatter_btm = dframe_scatter_btm[(dframe_scatter_btm['RS 2002 Permafrost'] == 'continuous') | (dframe_scatter_btm['RS 2002 Permafrost'] == 'discontinuous')]
...
top_fil = '/mnt/data/users/herringtont/soil_temp/scripts/dframe_top_Sep2021.csv'
btm_fil = '/mnt/data/users/herringtont/soil_temp/scripts/dframe_btm_Sep2021.csv'
...
dframe_master_warm = dframe_master[dframe_master['Season'] == 'Warm']

mpl.rcParams['font.size'] = 25

scatter1 = sn.PairGrid(dframe_master_warm,hue='Season')


sns.set_palette(sns.color_palette('Set2'))
#scatter1.map_upper(scatter_subset, mask=dframe_master['Layer'] == '0cm - 30cm', cmap=plt.get_cmap('Pastel1'))
scatter1.map_upper(scatter_subset, mask=dframe_master_warm['Layer'] == '30cm - 300cm')
...
plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_scatterplots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_thr_100_scatterplot_all_temp_new_data_CMOS_CLSM_all_layers_BEST_Sep2021_newJRA_warmseason_permafrost.png',format='png')
plt.close()
