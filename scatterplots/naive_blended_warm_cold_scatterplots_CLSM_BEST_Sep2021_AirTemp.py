...
scatter_fil_top = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon_top_30cm_thr_100_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021.csv'])
scatter_fil_btm = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon_30cm_300cm_thr_100_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021.csv'])
...
station_cold_top = dframe_cold_top['BEST Air'].values
naive_all_cold_top = dframe_cold_top['Naive Blend All Air'].values
CFSR_cold_top = dframe_cold_top['CFSR Air'].values
ERAI_cold_top = dframe_cold_top['ERA-Interim Air'].values
ERA5_cold_top = dframe_cold_top['ERA5 Air'].values
ERA5_Land_cold_top = dframe_cold_top['ERA5-Land Air'].values
JRA_cold_top = dframe_cold_top['JRA55 Air'].values
MERRA2_cold_top = dframe_cold_top['MERRA2 Air'].values
GLDAS_cold_top = dframe_cold_top['GLDAS-Noah Air'].values
GLDAS_CLSM_cold_top = dframe_cold_top['GLDAS-CLSM Air'].values
...
station_cold_btm = dframe_cold_btm['BEST Air'].values
naive_all_cold_btm = dframe_cold_btm['Naive Blend All Air'].values
CFSR_cold_btm = dframe_cold_btm['CFSR Air'].values
ERAI_cold_btm = dframe_cold_btm['ERA-Interim Air'].values
ERA5_cold_btm = dframe_cold_btm['ERA5 Air'].values
ERA5_Land_cold_btm = dframe_cold_btm['ERA5-Land Air'].values
JRA_cold_btm = dframe_cold_btm['JRA55 Air'].values
MERRA2_cold_btm = dframe_cold_btm['MERRA2 Air'].values
GLDAS_cold_btm = dframe_cold_btm['GLDAS-Noah Air'].values
GLDAS_CLSM_cold_btm = dframe_cold_btm['GLDAS-CLSM Air'].values

dframe_warm_top = pd.read_csv(scatter_fil_top)
dframe_warm_top = dframe_warm_top[dframe_warm_top['Season']  == 'Warm']
dframe_warm_top['Layer'] = '0cm - 30cm'
station_warm_top = dframe_warm_top['BEST Air'].values
naive_all_warm_top = dframe_warm_top['Naive Blend All Air'].values
CFSR_warm_top = dframe_warm_top['CFSR Air'].values
ERAI_warm_top = dframe_warm_top['ERA-Interim Air'].values
ERA5_warm_top = dframe_warm_top['ERA5 Air'].values
ERA5_Land_warm_top = dframe_warm_top['ERA5-Land Air'].values
JRA_warm_top = dframe_warm_top['JRA55 Air'].values
MERRA2_warm_top = dframe_warm_top['MERRA2 Air'].values
GLDAS_warm_top = dframe_warm_top['GLDAS-Noah Air'].values
GLDAS_CLSM_warm_top = dframe_warm_top['GLDAS-CLSM Air'].values
...
station_warm_btm = dframe_warm_btm['BEST Air'].values
naive_all_warm_btm = dframe_warm_btm['Naive Blend All Air'].values
CFSR_warm_btm = dframe_warm_btm['CFSR Air'].values
ERAI_warm_btm = dframe_warm_btm['ERA-Interim Air'].values
ERA5_warm_btm = dframe_warm_btm['ERA5 Air'].values
ERA5_Land_warm_btm = dframe_warm_btm['ERA5-Land Air'].values
JRA_warm_btm = dframe_warm_btm['JRA55 Air'].values
MERRA2_warm_btm = dframe_warm_btm['MERRA2 Air'].values
GLDAS_warm_btm = dframe_warm_btm['GLDAS-Noah Air'].values
GLDAS_CLSM_warm_btm = dframe_warm_btm['GLDAS-CLSM Air'].values

dframe_scatter_top = pd.read_csv(scatter_fil_top)
dframe_scatter_top['Layer'] = '0cm - 30cm'
station_scatter_top = dframe_scatter_top['BEST Air'].values
naive_all_scatter_top = dframe_scatter_top['Naive Blend All Air'].values
CFSR_scatter_top = dframe_scatter_top['CFSR Air'].values
ERAI_scatter_top = dframe_scatter_top['ERA-Interim Air'].values
ERA5_scatter_top = dframe_scatter_top['ERA5 Air'].values
ERA5_Land_scatter_top = dframe_scatter_top['ERA5-Land Air'].values
JRA_scatter_top = dframe_scatter_top['JRA55 Air'].values
MERRA2_scatter_top = dframe_scatter_top['MERRA2 Air'].values
GLDAS_scatter_top = dframe_scatter_top['GLDAS-Noah Air'].values
GLDAS_CLSM_scatter_top = dframe_scatter_top['GLDAS-CLSM Air'].values
...
station_scatter_btm = dframe_scatter_btm['BEST Air'].values
naive_all_scatter_btm = dframe_scatter_btm['Naive Blend All Air'].values
CFSR_scatter_btm = dframe_scatter_btm['CFSR Air'].values
ERAI_scatter_btm = dframe_scatter_btm['ERA-Interim Air'].values
ERA5_scatter_btm = dframe_scatter_btm['ERA5 Air'].values
ERA5_Land_scatter_btm = dframe_scatter_btm['ERA5-Land Air'].values
JRA_scatter_btm = dframe_scatter_btm['JRA55 Air'].values
MERRA2_scatter_btm = dframe_scatter_btm['MERRA2 Air'].values
GLDAS_scatter_btm = dframe_scatter_btm['GLDAS-Noah Air'].values
GLDAS_CLSM_scatter_btm = dframe_scatter_btm['GLDAS-CLSM Air'].values
...
plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_scatterplots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_thr_100_scatterplot_all_temp_new_data_CMOS_CLSM_all_layers_BEST_Sep2021_newJRA_AirTemp.png')
plt.close()
