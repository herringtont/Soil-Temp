...
dframe_cold_top = dframe_cold_top[(dframe_cold_top['RS 2002 Permafrost'] == 'none')]
...
dframe_cold_btm = dframe_cold_btm[(dframe_cold_btm['RS 2002 Permafrost'] == 'none')]
...
dframe_warm_top = dframe_warm_top[(dframe_warm_top['RS 2002 Permafrost'] == 'none')]
...
dframe_warm_btm = dframe_warm_btm[(dframe_warm_btm['RS 2002 Permafrost'] == 'none')]
...
dframe_scatter_top = dframe_scatter_top[(dframe_scatter_top['RS 2002 Permafrost'] == 'none')]
...
dframe_scatter_btm = dframe_scatter_btm[(dframe_scatter_btm['RS 2002 Permafrost'] == 'none')]
...
plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_scatterplots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_thr_100_scatterplot_all_temp_new_data_CMOS_CLSM_all_layers_BEST_Sep2021_newJRA_warmseason_none.png',format='png')
plt.close()
