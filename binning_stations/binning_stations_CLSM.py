...
ERAI_fic = "/mnt/data/users/herringtont/soil_temp/reanalysis/monthly/remap/rename/GLDAS_CLSM.nc"
ERAI_fib = "/mnt/data/users/herringtont/soil_temp/reanalysis/monthly/remap/rename/GLDAS_CLSM.nc"
ERAI_fin = "/mnt/data/users/herringtont/soil_temp/reanalysis/monthly/remap/rename/GLDAS_CLSM.nc"
...
stn_L1_fil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/pre_join/geometry_L1_CLSM_prejoin.csv"])
stn_L2_fil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/pre_join/geometry_L2_CLSM_prejoin.csv"])
stn_L3_fil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/pre_join/geometry_L3_CLSM_prejoin.csv"])
stn_L4_fil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/pre_join/geometry_L4_CLSM_prejoin.csv"])
stn_L5_fil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/pre_join/geometry_L5_CLSM_prejoin.csv"])
stn_top30_fil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/pre_join/geometry_top30_CLSM_prejoin.csv"])
stn_L7_fil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/pre_join/geometry_L7_CLSM_prejoin.csv"])

dframe_stn_O_L1_geo.to_csv(stn_L1_fil,na_rep=np.nan,index=False)
dframe_stn_O_L2_geo.to_csv(stn_L2_fil,na_rep=np.nan,index=False)
dframe_stn_O_L3_geo.to_csv(stn_L3_fil,na_rep=np.nan,index=False)
dframe_stn_O_L4_geo.to_csv(stn_L4_fil,na_rep=np.nan,index=False)
dframe_stn_O_L5_geo.to_csv(stn_L5_fil,na_rep=np.nan,index=False)
...
dframe_grid_geob_lat = dframe_grid_geob_cen.y.values
dframe_grid_geob_lon = dframe_grid_geob_cen.x.values 

dframe_grid_geon_lat = dframe_grid_geon_cen.y.values
dframe_grid_geon_lon = dframe_grid_geon_cen.x.values 

dframe_grid_geoc_lat = dframe_grid_geoc_cen.y.values
dframe_grid_geoc_lon = dframe_grid_geoc_cen.x.values
 
dframe_grid_geob['Lat Cen'] = dframe_grid_geob_lat
dframe_grid_geob['Lon Cen'] = dframe_grid_geob_lon

dframe_grid_geon['Lat Cen'] = dframe_grid_geon_lat
dframe_grid_geon['Lon Cen'] = dframe_grid_geon_lon

dframe_grid_geoc['Lat Cen'] = dframe_grid_geoc_lat
dframe_grid_geoc['Lon Cen'] = dframe_grid_geoc_lon

cen_geob_fil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/centroid/dframe_geob.csv"])
cen_geon_fil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/centroid/dframe_geon.csv"])
cen_geoc_fil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/centroid/dframe_geoc.csv"])

dframe_grid_geob.to_csv(cen_geob_fil,na_rep=np.nan,index=False)
dframe_grid_geon.to_csv(cen_geon_fil,na_rep=np.nan,index=False)
...
O_L1_filb = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L1_bil_CLSM.csv"])
O_L2_filb = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L2_bil_CLSM.csv"])
O_L3_filb = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L3_bil_CLSM.csv"])
O_L4_filb = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L4_bil_CLSM.csv"])
O_L5_filb = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L5_bil_CLSM.csv"])
O_top30_filb = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_top30_bil_CLSM.csv"])
O_L7_filb = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L7_bil_CLSM.csv"])

O_L1_filn = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L1_nn_CLSM.csv"])
O_L2_filn = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L2_nn_CLSM.csv"])
O_L3_filn = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L3_nn_CLSM.csv"])
O_L4_filn = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L4_nn_CLSM.csv"])
O_L5_filn = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L5_nn_CLSM.csv"])
O_top30_filn = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_top30_nn_CLSM.csv"])
O_L7_filn = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L7_nn_CLSM.csv"])

O_L1_filc = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L1_con_CLSM.csv"])
O_L2_filc = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L2_con_CLSM.csv"])
O_L3_filc = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L3_con_CLSM.csv"])
O_L4_filc = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L4_con_CLSM.csv"])
O_L5_filc = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L5_con_CLSM.csv"])
O_top30_filc = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_top30_con_CLSM.csv"])
O_L7_filc = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/spatial_join/CLSM/geometry_L7_con_CLSM.csv"])
