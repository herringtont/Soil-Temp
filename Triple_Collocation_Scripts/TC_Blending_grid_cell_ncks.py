...
################################## grab corresponding reanalysis data ##################################
    				base_dir  = "".join(["/mnt/data/users/herringtont/soil_temp/reanalysis/monthly/remap/rename/common_grid/remap",rmph,"/common_date/ncks_method/"])
    				CFSR_fi = "".join([base_dir,"CFSR_all_grid_"+str(gcell),".nc"])
    				MERRA2_fi = "".join([base_dir,"MERRA2_grid_"+str(gcell),".nc"])
    				ERA5_fi = "".join([base_dir,"ERA5_grid_"+str(gcell),".nc"])
    				ERAI_fi = "".join([base_dir,"ERA-Interim_grid_"+str(gcell),".nc"])
    				JRA_fi = "".join([base_dir,"JRA55_grid_"+str(gcell),".nc"])
    				GLDAS_fi = "".join([base_dir,"GLDAS_grid_"+str(gcell),".nc"])
    				#print(CFSR_fi)
...
#    			TC_ofila = ''.join([TC_odira+str(remap_type)+'_'+str(olri)+'_'+str(lyrj)+'_thr'+str(thrk)+'_TC_output_gcell_level_anom_ncks.csv'])
#    			print(TC_ofila)
#    			#print(dframe_TC)
...
#    			TC_ofilr = ''.join([TC_odirr+str(remap_type)+'_'+str(olri)+'_'+str(lyrj)+'_thr'+str(thrk)+'_TC_output_gcell_level_raw_ncks.csv'])
#    			print(TC_ofilr)
#    			#print(dframe_TC)
...
###############################################################################################################
    			...
    			for g in grid_celluq:
    				...
    				TC_fil_raw = ''.join([TC_dir_raw+str(remap_type)+'_'+str(olri)+'_'+str(lyrj)+'_thr'+str(thrk)+'_TC_output_gcell_level_raw_ncks.csv'])
    				...
    				TC_fil_anom = ''.join([TC_dir_anom+str(remap_type)+'_'+str(olri)+'_'+str(lyrj)+'_thr'+str(thrk)+'_TC_output_gcell_level_anom_ncks.csv'])
...
#### create finalized blended dataframes ####
    			...
    			blend_fil_anom = ''.join(['/mnt/data/users/herringtont/soil_temp/Blended_Product/collocated/TC_blended/anom/'+str(remap_type)+'_'+str(olri)+'_'+str(lyrj)+'_thr'+str(thrk)+'_TC_blended_anom_ncks.csv'])
    			blend_fil_raw = ''.join(['/mnt/data/users/herringtont/soil_temp/Blended_Product/collocated/TC_blended/raw/'+str(remap_type)+'_'+str(olri)+'_'+str(lyrj)+'_thr'+str(thrk)+'_TC_blended_ncks.csv'])
