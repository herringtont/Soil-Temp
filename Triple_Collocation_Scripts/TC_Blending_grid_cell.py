...
########## drop lon,lat coordinates #########
    				...
    				GLDAS_stemp3 = GLDAS_stemp.sel(lat=lat_cen, lon=lon_cen, method='nearest',drop=True)
    				JRA_stemp3 = JRA_stemp.sel(lat=lat_cen, lon=lon_cen, method='nearest',drop=True)
    				ERAI_stemp3 = ERAI_stemp.sel(lat=lat_cen, lon=lon_cen, method='nearest',drop=True)
    				ERA5_stemp3 = ERA5_stemp.sel(lat=lat_cen, lon=lon_cen, method='nearest',drop=True)
    				MERRA2_stemp3 = MERRA2_stemp.sel(lat=lat_cen, lon=lon_cen, method='nearest',drop=True)
    				CFSR_stemp3 = CFSR_stemp.sel(lat=lat_cen, lon=lon_cen, method='nearest',drop=True)
...
#    			TC_ofila = ''.join([TC_odira+str(remap_type)+'_'+str(olri)+'_'+str(lyrj)+'_thr'+str(thrk)+'_TC_output_gcell_level_anom.csv'])
#    			print(TC_ofila)
#    			#print(dframe_TC)
...
#    			TC_ofilr = ''.join([TC_odirr+str(remap_type)+'_'+str(olri)+'_'+str(lyrj)+'_thr'+str(thrk)+'_TC_output_gcell_level_raw.csv'])
#    			print(TC_ofilr)
#    			#print(dframe_TC)
...
##############################################################################################################
    			...
    			for g in grid_celluq:
    				...
    				TC_fil_raw = ''.join([TC_dir_raw+str(remap_type)+'_'+str(olri)+'_'+str(lyrj)+'_thr'+str(thrk)+'_TC_output_gcell_level_raw.csv'])
    				...
    				TC_fil_anom = ''.join([TC_dir_anom+str(remap_type)+'_'+str(olri)+'_'+str(lyrj)+'_thr'+str(thrk)+'_TC_output_gcell_level_anom.csv'])
