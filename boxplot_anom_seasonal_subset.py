...
################################# create master arrays for in-situ, model data ######################################
    			...
    			indir = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/spatial_average/subset_single/remap",rmph,"/",olri,"/",lyrj,"/thr_",thrk,"/"])
    			indira = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/spatial_average_anom/subset_single/remap",rmph,"/",olri,"/",lyrj,"/thr_",thrk,"/"])
...
################## Create Boxplots ####################
    			...
    			bplot_fil = "".join(["/mnt/data/users/herringtont/soil_temp/plots/boxplots/subset_single/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_boxplot_anom_subset_single.png"])
    			print(bplot_fil)
