...
###### warm Season (Soil Temp <= -2) #####
    				...
    				timeseries_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/new_data/CLSM_res/'+str(remap_type)+"_"+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_'+str(thr_m)+'_data_CMOS_CLSM.csv'])
