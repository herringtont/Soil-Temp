...
#
######################## create figures #########################
#    			corr_filS = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/seasonal/subset_multiple/Spearman/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_corr_matrix_Spearman_anom_seasonal_subset_multiple.png"])
#    			print(corr_filS)
...
#
######################## create figures #########################
#    			corr_filP = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/seasonal/subset_multiple/Pearson/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_corr_matrix_Pearson_anom_seasonal_subset_multiple.png"])
#    			print(corr_filP)
#    			#plt.suptitle('Pearsons R Correlation Matrix SON')
#    			#plt.title("Remap Type: "+str(remap_type)+", outlier_type: "+str(olri)+", layer: "+str(lyrj)+", threshold: thr"+str(thrk))
#    			#plt.autoscale(enable=True,axis='both',tight=None)
...
####################### Create DJF Scatterplots #####################
    			...
    			splot_fil = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/seasonal/Scatterplot/subset_multiple/DJF/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_scatter_DJF_subset_multiple.png"])
    			print(splot_fil)
    			plt.tight_layout()
...
####################### Create MAM Scatterplots #####################
    			...
    			plt.xlabel('Soil Temp Anomaly($^\circ$ C)',fontweight='bold')
    			plt.ylabel('Soil Temp Anomaly($^\circ$ C)',fontweight='bold')
    			splot_fil = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/seasonal/Scatterplot/subset_multiple/MAM/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_scatter_MAM_subset_multiple.png"])
    			print(splot_fil)
    			plt.tight_layout()
    			plt.savefig(splot_fil)
    			plt.close()
...
####################### Create JJA Scatterplots #####################
    			...
    			plt.xlabel('Soil Temp Anomaly($^\circ$ C)',fontweight='bold')
    			plt.ylabel('Soil Temp Anomaly($^\circ$ C)',fontweight='bold')
    			splot_fil = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/seasonal/Scatterplot/subset_multiple/JJA/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_scatter_JJA_subset_multiple.png"])
    			print(splot_fil)
    			plt.tight_layout()
    			plt.savefig(splot_fil)
    			plt.close()
...
####################### Create SON Scatterplots #####################
    			...
    			plt.xlabel('Soil Temp Anomaly($^\circ$ C)',fontweight='bold')
    			plt.ylabel('Soil Temp Anomaly($^\circ$ C)',fontweight='bold')
    			splot_fil = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/seasonal/Scatterplot/subset_multiple/SON/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_scatter_SON_subset_multiple.png"])
    			print(splot_fil)
    			plt.tight_layout()
    			plt.savefig(splot_fil)
    			plt.close()
