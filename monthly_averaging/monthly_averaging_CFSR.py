...
top30_fi = "".join([geom_dir,"geometry_top30_con_CFSR.csv"])
L7_fi = "".join([geom_dir,"geometry_L7_con_CFSR.csv"])
...
########### Calculate Daily Average ############
    			...
    			ofilOday = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/layer_average/no_outliers/",O_id,"/",L_id,"/","daily_average/CFSR/","site_",str(sitid),".csv"])
    			path_O = pathlib.Path(ofilOday)
    			path_O.parent.mkdir(parents=True,exist_ok=True)
    			ofilZday = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/layer_average/no_outliers/",Z_id,"/",L_id,"/","daily_average/CFSR/","site_",str(sitid),".csv"])
    			path_Z = pathlib.Path(ofilZday)
    			path_Z.parent.mkdir(parents=True,exist_ok=True)
    			ofilIday = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/layer_average/no_outliers/",I_id,"/",L_id,"/","daily_average/CFSR/","site_",str(sitid),".csv"])
...
######################### create temporary monthly file #######################
    			ofilO = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/layer_average/no_outliers/",O_id,"/",L_id,"/","monthly_average/",thr_fld,"/CFSR/","site_",str(sitid),".csv"])
    			path_O = pathlib.Path(ofilO)
    			path_O.parent.mkdir(parents=True,exist_ok=True)
    			ofilZ = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/layer_average/no_outliers/",Z_id,"/",L_id,"/","monthly_average/",thr_fld,"/CFSR/","site_",str(sitid),".csv"])
    			path_Z = pathlib.Path(ofilZ)
    			path_Z.parent.mkdir(parents=True,exist_ok=True)
    			ofilI = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/layer_average/no_outliers/",I_id,"/",L_id,"/","monthly_average/",thr_fld,"/CFSR/","site_",str(sitid),".csv"])
