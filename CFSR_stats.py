...
######## Set Directories ########
CFSR_dir = "/mnt/data/users/herringtont/soil_temp/reanalysis/monthly/remap/rename/site_level/CFSR/"
CFSR2_dir = "/mnt/data/users/herringtont/soil_temp/reanalysis/monthly/remap/rename/site_level/CFSR2/"
...
######### loop through files #########
    for i in range (1,300):
    	i_string = str(i)
    	CFSR_fil = "".join([CFSR_dir,"CFSR_site_",i_string,".nc"])
    	CFSR2_fil = "".join([CFSR2_dir,"CFSR2_site_",i_string,".nc"])
    	#print(CFSR_fil)
...
stat_list_LY1 = {'Site':site_LY1,'T-Stat':T_LY1,'P of T-Test':P1_LY1,'F-Stat':F_LY1,'P of F-Test':P2_LY1}
dframe_LY1 = pd.DataFrame(stat_list_LY1)
dframe_LY1.to_csv('/mnt/data/users/herringtont/soil_temp/CFSR_stats/CFSR_stats_L1.csv',index=False)

stat_list_LY2 = {'Site':site_LY2,'T-Stat':T_LY2,'P of T-Test':P1_LY2,'F-Stat':F_LY2,'P of F-Test':P2_LY2}
dframe_LY2 = pd.DataFrame(stat_list_LY2)
dframe_LY2.to_csv('/mnt/data/users/herringtont/soil_temp/CFSR_stats/CFSR_stats_L2.csv',index=False)

stat_list_LY3 = {'Site':site_LY3,'T-Stat':T_LY3,'P of T-Test':P1_LY3,'F-Stat':F_LY3,'P of F-Test':P2_LY3}
dframe_LY3 = pd.DataFrame(stat_list_LY3)
dframe_LY3.to_csv('/mnt/data/users/herringtont/soil_temp/CFSR_stats/CFSR_stats_L3.csv',index=False)

stat_list_LY4 = {'Site':site_LY4,'T-Stat':T_LY4,'P of T-Test':P1_LY4,'F-Stat':F_LY1,'P of F-Test':P2_LY4}
dframe_LY4 = pd.DataFrame(stat_list_LY4)
dframe_LY4.to_csv('/mnt/data/users/herringtont/soil_temp/CFSR_stats/CFSR_stats_L4.csv',index=False)
