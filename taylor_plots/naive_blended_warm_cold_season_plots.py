    	...
    	for k in olr:
    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				for n in temp_thr:
    					temp_thr_n = n
    					cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_cold_season_temp_master_ERA5_'+str(temp_thr_n)+'.csv'])
    					warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_warm_season_temp_master_ERA5_'+str(temp_thr_n)+'.csv'])    			
    					scatter_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_ERA5_'+str(temp_thr_n)+'.csv'])
    					...
    					naive_noJRA55 = dframe_warm['Naive Blend no JRA55'].values
    					...
    					naive_noJRA55 = dframe_scatter['Naive Blend no JRA55'].values
...
###### Cold Season (Temp) #######
    					...
    					dframe_cold_season_temp_corr = dframe_cold[['Station','Naive Blend','Naive Blend no JRA55','CFSR','ERA-Interim','ERA5','ERA5-Land','JRA55','MERRA2','GLDAS-Noah','GLDAS-CLSM']]
...
###### Warm Season (Temp) #######
    					dframe_warm_season_temp_corr = dframe_warm[['Station','Naive Blend','Naive Blend no JRA55','CFSR','ERA-Interim','ERA5','ERA5-Land','JRA55','MERRA2','GLDAS-Noah','GLDAS-CLSM']]
    					...
    					plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_correlation/new_data/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_correlation_byseason_ERA5_'+str(temp_thr_n)+'_new_data.png')
    					plt.close()
...
###### Cold Season (Temp) ######
    					...
    					plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_scatterplots/new_data/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_scatterplot_all_temp_ERA5_'+str(temp_thr_n)+'_new_data.png')
    					plt.close()		
...
###### Cold Season (Temp) #####
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/'
    					taylor_plt_fil_cold = ''.join([taylor_dir,str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_cold_new_data.png'])
    					...
    					label = {'Station':'dimgrey','Naive Blend': 'dodgerblue', 'Naive Blend no JRA55': 'mediumslateblue', 'CFSR': 'm','ERA-Interim': 'limegreen', 'ERA5': 'cyan','ERA5-Land': 'skyblue', 'JRA55': 'red', 'MERRA2': 'goldenrod', 'GLDAS-Noah': 'black','GLDAS-CLSM': 'darkgrey'}
...
###### Warm Season (Temp) #####
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/'
    					taylor_plt_fil_warm = ''.join([taylor_dir,str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_warm_new_data.png'])
