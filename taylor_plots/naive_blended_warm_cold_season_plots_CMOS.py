    	...
    	for k in olr:
    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				for n in temp_thr:
    					temp_thr_n = n
    					cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/new_depth/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_cold_season_temp_master_ERA5_'+str(temp_thr_n)+'_CMOS_newdepth.csv'])
    					warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/new_depth/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_warm_season_temp_master_ERA5_'+str(temp_thr_n)+'_CMOS_newdepth.csv'])    			
    					scatter_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/new_depth/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_ERA5_'+str(temp_thr_n)+'_CMOS_newdepth.csv'])
    					...
    					dframe_scatter2 = pd.DataFrame({'Station':station_scatter,'Season':season_scatter,'Naive Blend':naive_all_scatter,'CFSR':CFSR_scatter,'ERA-Interim':ERAI_scatter,'ERA5':ERA5_scatter,'ERA5-Land':ERA5_Land_scatter,'JRA55':JRA_scatter,'MERRA2':MERRA2_scatter,'GLDAS-Noah':GLDAS_scatter,'GLDAS-CLSM':GLDAS_CLSM_scatter})
    					dframe_cold2 = pd.DataFrame({'Station':station_cold,'Naive Blend':naive_all_cold,'CFSR':CFSR_cold,'ERA-Interim':ERAI_cold,'ERA5':ERA5_cold,'ERA5-Land':ERA5_Land_cold,'JRA55':JRA_cold,'MERRA2':MERRA2_cold,'GLDAS-Noah':GLDAS_cold,'GLDAS-CLSM':GLDAS_CLSM_cold})
    					dframe_warm2 = pd.DataFrame({'Station':station_warm,'Naive Blend':naive_all_warm,'CFSR':CFSR_warm,'ERA-Interim':ERAI_warm,'ERA5':ERA5_warm,'ERA5-Land':ERA5_Land_warm,'JRA55':JRA_warm,'MERRA2':MERRA2_warm,'GLDAS-Noah':GLDAS_warm,'GLDAS-CLSM':GLDAS_CLSM_warm})
...
###### Warm Season (Temp) #######
    					...
    					plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_correlation/new_data/CMOS_poster/new_depth/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_correlation_byseason_ERA5_'+str(temp_thr_n)+'_new_data_CMOS_newdepth.png')
    					plt.close()
...
###### Cold Season (Temp) ######
    					...
    					plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_scatterplots/new_data/CMOS_poster/new_depth/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_scatterplot_all_temp_ERA5_'+str(temp_thr_n)+'_new_data_CMOS_newdepth.png')
    					plt.close()		
...
###### Cold Season (Temp) #####
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CMOS_poster/new_depth/'
    					taylor_plt_fil_cold = ''.join([taylor_dir,str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_cold_new_data_CMOS_newdepth.png'])
    					...
    					label = {'Station':'dimgrey','Naive Blend':'fuchsia','CFSR': 'm','ERA-Interim': 'limegreen', 'ERA5': 'cyan','ERA5-Land':'skyblue','JRA55': 'red', 'MERRA2': 'goldenrod', 'GLDAS-Noah': 'black','GLDAS-CLSM':'darkgrey'}
...
###### Warm Season (Temp) #####
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CMOS_poster/new_depth/'
    					taylor_plt_fil_warm = ''.join([taylor_dir,str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_warm_new_data_CMOS_newdepth.png'])
