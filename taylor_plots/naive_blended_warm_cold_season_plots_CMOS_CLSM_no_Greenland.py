...
permafrost_type = ['RS_2002_continuous','Brown_1970_continuous','RS_2002_discontinuous','Brown_1970_discontinuous']
############# Grab Data ##############
    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				for n in temp_thr:
    					...
    					naive_cold = dframe_cold['Naive Blend'].values
    					naive_noJRA_cold = dframe_cold['Naive Blend no JRA55'].values
    					naive_noJRAold_cold = dframe_cold['Naive Blend no JRA55 Old'].values
    					naive_all_cold = dframe_cold['Naive Blend All'].values
    					...
    					naive_warm = dframe_warm['Naive Blend'].values
    					naive_noJRA_warm = dframe_warm['Naive Blend no JRA55'].values
    					naive_noJRAold_warm = dframe_warm['Naive Blend no JRA55 Old'].values
    					naive_all_warm = dframe_warm['Naive Blend All'].values
    					...
    					season_scatter = dframe_scatter['Season'].values
...
#    					sns.set_context(rc={"axes.labelsize":20}, font_scale=1.25)
#    					sns.set_context(rc={"legend.fontsize":18}, font_scale=1.25)
####### Cold Season (Temp) #######
#
...
#
#    					plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_correlation/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_correlation_byseason_ERA5_'+str(temp_thr_n)+'_new_data_CMOS_CLSM_noGreenland.png')
#    					plt.close()
...
#    					plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_scatterplots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_scatterplot_all_temp_ERA5_'+str(temp_thr_n)+'_new_data_CMOS_CLSM_noGreenland.png')
#    					plt.close()		
#
#
#
...
#    					naive_noJRA_cold_season_temp = dframe_cold['Naive Blend no JRA55'].values
#    					naive_noJRAold_cold_season_temp = dframe_cold['Naive Blend no JRA55 Old'].values
#    					naive_all_cold_season_temp = dframe_cold['Naive Blend All'].values
...
#    					taylor_plt_fil_cold = ''.join([taylor_dir,str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_cold_new_data_CMOS_CLSM_noGreenland.png'])
#
...
#    					naive_noJRA_warm_season_temp = dframe_warm['Naive Blend no JRA55'].values
#    					naive_noJRAold_warm_season_temp = dframe_warm['Naive Blend no JRA55 Old'].values
#    					naive_all_warm_season_temp = dframe_warm['Naive Blend All'].values
...
#
#    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CMOS_poster/CLSM_res/'
#    					taylor_plt_fil_warm = ''.join([taylor_dir,str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_warm_new_data_CMOS_CLSM_noGreenland.png'])
#
...
###### Cold Season (Temp) #####
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CMOS_poster/CLSM_res/'
    					taylor_plt_fil_cold = ''.join([taylor_dir,str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_cold_new_data_CMOS_CLSM_Blends.png'])
    					...
    					label = {'Station':'dimgrey','Blend-5':'dodgerblue','Blend-8':'fuchsia','Blend-4':'mediumslateblue','Blend-7':'burlywood'}

    					sm.taylor_diagram(sdev_naive,crmsd_naive,ccoef_naive,tickSTD=[0,0.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5,9,9.5,10],axismax=10.0,styleSTD = '-.', widthSTD = 0.5,styleOBS = '-',tickRMS=np.arange(0,8,1),tickRMSangle = 90.0,styleRMS = ':', widthRMS = 0.5,widthCOR = 0.5,colOBS = 'dimgrey',markerobs = 'o',titleOBS = 'Station', markercolor='dodgerblue', markerSize =10, markerLabelcolor='dodgerblue')
    					sm.taylor_diagram(sdev_naive_all,crmsd_naive_all,ccoef_naive_all,tickSTD=[0,0.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5,9,9.5,10],axismax=10.0,styleSTD = '-.', widthSTD = 0.5,styleOBS = '-',tickRMS=np.arange(0,8,1),tickRMSangle = 90.0,styleRMS = ':', widthRMS = 0.5,widthCOR = 0.5,colOBS = 'dimgrey',markerobs = 'o',titleOBS = 'Station', markercolor='fuchsia', markerSize=10, markerLabelcolor='fuchsia',overlay='on')
    					sm.taylor_diagram(sdev_naive_noJRAold,crmsd_naive_noJRAold,ccoef_naive_noJRAold,tickSTD=[0,0.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5,9,9.5,10],axismax=10.0,styleSTD = '-.', widthSTD = 0.5,styleOBS = '-',tickRMS=np.arange(0,8,1),tickRMSangle = 90.0,styleRMS = ':', widthRMS = 0.5,widthCOR = 0.5, markercolor='mediumslateblue', markerLabelcolor='mediumslateblue',markerSize=10,overlay='on')
    					sm.taylor_diagram(sdev_naive_noJRA,crmsd_naive_noJRA,ccoef_naive_noJRA,tickSTD=[0,0.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5,9,9.5,10],axismax=10.0,styleSTD = '-.', widthSTD = 0.5,styleOBS = '-',tickRMS=np.arange(0,8,1),tickRMSangle = 90.0,styleRMS = ':', widthRMS = 0.5,widthCOR = 0.5, markercolor='burlywood', markerLabelcolor='burlywood',markerSize=10,overlay='on',markerLabel=label)
...
###### Warm Season (Temp) #####
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CMOS_poster/CLSM_res/'
    					taylor_plt_fil_warm = ''.join([taylor_dir,str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_warm_new_data_CMOS_CLSM_Blends.png'])
    					...
    					sdev = np.array([taylor_stats_naive_warm_temp['sdev'][0],taylor_stats_naive_warm_temp['sdev'][1],taylor_stats_naive_all_warm_temp['sdev'][1],taylor_stats_naive_noJRAold_warm_temp['sdev'][1],taylor_stats_naive_noJRA_cold_temp['sdev'][1]])
    					crmsd = np.array([taylor_stats_naive_warm_temp['crmsd'][0],taylor_stats_naive_warm_temp['crmsd'][1],taylor_stats_naive_all_warm_temp['crmsd'][1],taylor_stats_naive_noJRAold_warm_temp['crmsd'][1],taylor_stats_naive_noJRA_warm_temp['crmsd'][1]])
    					ccoef = np.array([taylor_stats_naive_warm_temp['ccoef'][0],taylor_stats_naive_warm_temp['ccoef'][1],taylor_stats_naive_all_warm_temp['ccoef'][1],taylor_stats_naive_noJRAold_warm_temp['ccoef'][1],taylor_stats_naive_noJRA_warm_temp['ccoef'][1]])
								
    					#sm.taylor_diagram(sdev,crmsd,ccoef,tickSTD=[0,0.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5,9,9.5,10],axismax=10.0,styleSTD = '-.', widthSTD = 0.5,styleOBS = '-',tickRMS=np.arange(0,4,1),tickRMSangle = 90.0,styleRMS = ':', widthRMS = 0.5,widthCOR = 0.5,colOBS = 'dimgrey',markerobs = 'o',titleOBS = 'Station',markerLabel=label,markerLegend='on', markerSize = 4, alpha = 0.0)
    					sm.taylor_diagram(sdev_naive,crmsd_naive,ccoef_naive,tickSTD=[0,0.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5,9,9.5,10],axismax=10.0,styleSTD = '-.', widthSTD = 0.5,styleOBS = '-',tickRMS=np.arange(0,8,1),tickRMSangle = 90.0,styleRMS = ':', widthRMS = 0.5,widthCOR = 0.5,colOBS = 'dimgrey',markerobs = 'o',titleOBS = 'Station', markercolor='dodgerblue', markerSize =10, markerLabelcolor='dodgerblue')
    					sm.taylor_diagram(sdev_naive_all,crmsd_naive_all,ccoef_naive_all,tickSTD=[0,0.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5,9,9.5,10],axismax=10.0,styleSTD = '-.', widthSTD = 0.5,styleOBS = '-',tickRMS=np.arange(0,8,1),tickRMSangle = 90.0,styleRMS = ':', widthRMS = 0.5,widthCOR = 0.5,colOBS = 'dimgrey',markerobs = 'o',titleOBS = 'Station', markercolor='fuchsia', markerSize=10, markerLabelcolor='fuchsia',overlay='on')
    					sm.taylor_diagram(sdev_naive_noJRAold,crmsd_naive_noJRAold,ccoef_naive_noJRAold,tickSTD=[0,0.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5,9,9.5,10],axismax=10.0,styleSTD = '-.', widthSTD = 0.5,styleOBS = '-',tickRMS=np.arange(0,8,1),tickRMSangle = 90.0,styleRMS = ':', widthRMS = 0.5,widthCOR = 0.5, markercolor='mediumslateblue', markerLabelcolor='mediumslateblue',markerSize=10,overlay='on')
    					sm.taylor_diagram(sdev_naive_noJRA,crmsd_naive_noJRA,ccoef_naive_noJRA,tickSTD=[0,0.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5,6,6.5,7,7.5,8,8.5,9,9.5,10],axismax=10.0,styleSTD = '-.', widthSTD = 0.5,styleOBS = '-',tickRMS=np.arange(0,8,1),tickRMSangle = 90.0,styleRMS = ':', widthRMS = 0.5,widthCOR = 0.5, markercolor='burlywood', markerLabelcolor='burlywood',markerSize=10,overlay='on',markerLabel=label)
