    	...
    	for k in olr:
    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				for n in temp_thr:
    					temp_thr_n = n
    					cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_cold_season_temp_master_ERA5_'+str(temp_thr_n)+'_CMOS_CLSM.csv'])
    					warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_warm_season_temp_master_ERA5_'+str(temp_thr_n)+'_CMOS_CLSM.csv'])    			
    					scatter_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_ERA5_'+str(temp_thr_n)+'_CMOS_CLSM.csv'])
...
###### Warm Season (Temp) #######
    					...
    					plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_correlation/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_correlation_byseason_ERA5_'+str(temp_thr_n)+'_new_data_CMOS_CLSM.png')
    					plt.close()
...
###### Cold Season (Temp) ######
    					...
    					plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_scatterplots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_scatterplot_all_temp_ERA5_'+str(temp_thr_n)+'_new_data_CMOS_CLSM.png')
    					plt.close()		
...
###### Cold Season (Temp) #####
    					...
    					taylor_plt_fil_cold = ''.join([taylor_dir,str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_cold_new_data_CMOS_CLSM.png'])
...
###### Warm Season (Temp) #####
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CMOS_poster/CLSM_res/'
    					taylor_plt_fil_warm = ''.join([taylor_dir,str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_warm_new_data_CMOS_CLSM.png'])
