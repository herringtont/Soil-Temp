    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				for n in permafrost_type:
    					...
    					dframe = dframe[dframe['Continent'] == 'Eurasia']
...
##################### Create Taylor Diagrams ####################
    					...
    					taylor_plt_fil_cold = ''.join([taylor_dir,str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_taylor_diagram_cold_new_data_CMOS_CLSM_grid_cell_BEST_Sep2021_NWT_Yukon_sites_1yr_Eur.png'])
...
##################### Create Taylor Diagrams ####################
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CMOS_poster/CLSM_res/'
    					taylor_plt_fil_warm = ''.join([taylor_dir,str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_taylor_diagram_warm_new_data_CMOS_CLSM_grid_cell_BEST_Sep2021_NWT_Yukon_sites1yr_Eur.png'])
