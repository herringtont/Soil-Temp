    			...
    			for m in thr:
    				...
    				for n in permafrost_type:
    					...
    					if (permafrost_type_o == 'RS_2002_continuous'):
    						dframe_cold_permafrost = dframe_cold[dframe_cold['RS 2002 Permafrost'] == 'continuous']

    					elif (permafrost_type_o == 'Brown_1970_continuous'):
    						dframe_cold_permafrost = dframe_cold[dframe_cold['Brown 1970 Permafrost'] == 'continuous']

    					elif (permafrost_type_o == 'RS_2002_discontinuous'):
    						dframe_cold_permafrost = dframe_cold[dframe_cold['RS 2002 Permafrost'] == 'discontinuous']

    					elif (permafrost_type_o == 'Brown_1970_discontinuous'):
    						dframe_cold_permafrost = dframe_cold[dframe_cold['Brown 1970 Permafrost'] == 'discontinuous']

    					elif (permafrost_type_o == 'Brown_1970_none'):
    						dframe_cold_permafrost = dframe_cold[dframe_cold['Brown 1970 Permafrost'] == 'none']
    					...
    					if (permafrost_type_o == 'RS_2002_continuous'):
    						dframe_warm_permafrost = dframe_warm[dframe_warm['RS 2002 Permafrost'] == 'continuous']

    					elif (permafrost_type_o == 'Brown_1970_continuous'):
    						dframe_warm_permafrost = dframe_warm[dframe_warm['Brown 1970 Permafrost'] == 'continuous']

    					elif (permafrost_type_o == 'RS_2002_discontinuous'):
    						dframe_warm_permafrost = dframe_warm[dframe_warm['RS 2002 Permafrost'] == 'discontinuous']

    					elif (permafrost_type_o == 'Brown_1970_discontinuous'):
    						dframe_warm_permafrost = dframe_warm[dframe_warm['Brown 1970 Permafrost'] == 'discontinuous']

    					elif (permafrost_type_o == 'Brown_1970_none'):
    						dframe_warm_permafrost = dframe_warm[dframe_warm['Brown 1970 Permafrost'] == 'none']
...
###### Warm Season (Temp) #######
    					...
    					plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_correlation/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_correlation_byseason_new_data_CMOS_CLSM_'+str(permafrost_type_o)+'.png')
    					plt.close()
...
###### Cold Season (Temp) ######
    					...
    					plt.savefig('/mnt/data/users/herringtont/soil_temp/plots/naive_blend_scatterplots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_scatterplot_all_temp_new_data_CMOS_CLSM_'+str(permafrost_type_o)+'.png')
    					plt.close()		
...
###### Cold Season (Temp) #####
    					...
    					taylor_plt_fil_cold = ''.join([taylor_dir,str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_cold_new_data_CMOS_CLSM_'+str(permafrost_type_o)+'.png'])
...
###### Warm Season (Temp) #####
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CMOS_poster/CLSM_res/'
    					taylor_plt_fil_warm = ''.join([taylor_dir,str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_ERA5_'+str(temp_thr_n)+'_taylor_diagram_warm_new_data_CMOS_CLSM_'+str(permafrost_type_o)+'.png'])
