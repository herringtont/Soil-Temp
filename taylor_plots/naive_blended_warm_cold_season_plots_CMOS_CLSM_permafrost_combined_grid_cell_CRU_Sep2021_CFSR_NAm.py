    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				for n in permafrost_type:
    					permafrost_type_o = n
    					cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon'+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_CRU_Sep2021_airtemp_CFSR.csv'])
    					warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon'+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_CRU_Sep2021_airtemp_CFSR.csv'])    			
    					scatter_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/remapcon'+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_CRU_Sep2021_airtemp_CFSR.csv'])
...
##################### Create Taylor Diagrams ####################
    					...
    					taylor_plt_fil_cold = ''.join([taylor_dir,str(lyr_l)+'_taylor_diagram_cold_'+str(permafrost_type_o)+'_combined_grid_cell_CRU_Sep2021_CFSR_NAm.tiff'])
...
##################### Create Taylor Diagrams ####################
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CFSR_res/'
    					taylor_plt_fil_warm = ''.join([taylor_dir,str(lyr_l)+'_taylor_diagram_warm_'+str(permafrost_type_o)+'_combined_grid_cell_CRU_Sep2021_CFSR_NAm.tiff'])
