...
##################### Create Taylor Diagrams ####################
    					...
    					taylor_plt_fil_cold = ''.join([taylor_dir,str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_taylor_diagram_grid_cell_CRU_Sep2021_CFSR_NWT_Yukon_cold.tiff'])
...
##################### Create Taylor Diagrams ####################
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CFSR_res/'
    					taylor_plt_fil_warm = ''.join([taylor_dir,str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_taylor_diagram_grid_cell_CRU_Sep2021_CFSR_NWT_Yukon_warm.tiff'])
