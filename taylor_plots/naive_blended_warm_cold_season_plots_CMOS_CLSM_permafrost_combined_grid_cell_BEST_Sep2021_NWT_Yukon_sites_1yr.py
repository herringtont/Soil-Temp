...
##################### Create Taylor Diagrams ####################
    					...
    					taylor_plt_fil_cold = ''.join([taylor_dir,str(lyr_l)+'_taylor_diagram_cold_'+str(permafrost_type_o)+'_combined_grid_cell_BEST_Sep2021_NWT_Yukon_sites_1yr.png'])
...
##################### Create Taylor Diagrams ####################
    					...
    					taylor_dir = '/mnt/data/users/herringtont/soil_temp/plots/taylor_diagrams/new_data/CMOS_poster/CLSM_res/'
    					taylor_plt_fil_warm = ''.join([taylor_dir,str(lyr_l)+'_taylor_diagram_warm_'+str(permafrost_type_o)+'_combined_grid_cell_BEST_Sep2021_NWT_Yukon_sites_1yr.png'])
