...
#    				ax.scatter(DataA,DataB,marker='o')
...
#    				axtext.append("Pearson Correlation: "+str(coef_Pdec))
#    				axtext.append("Spearman Correlation: "+str(coef_Sdec))				
...
#    			splot_fil = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/seasonal/Scatterplot/SON/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_scatter_SON.png"])
#    			print(splot_fil)
#    			plt.tight_layout()
...
####################### create figures #########################
    			corr_filS = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/seasonal/panel_plot/Spearman/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_corr_matrix_Spearman_anom_seasonal.png"])
    			print(corr_filS)
...
####################### create figures #########################
    			corr_filP = "".join(["/mnt/data/users/herringtont/soil_temp/plots/corr_matrix_anom/seasonal/panel_plot/Pearson/"+str(remap_type)+"_"+str(olri)+"_"+lyrj+"_thr"+str(thrk)+"_corr_matrix_Pearson_anom_seasonal.png"])
    			print(corr_filP)
    			#plt.suptitle('Pearsons R Correlation Matrix SON')
    			#plt.title("Remap Type: "+str(remap_type)+", outlier_type: "+str(olri)+", layer: "+str(lyrj)+", threshold: thr"+str(thrk))
    			#plt.autoscale(enable=True,axis='both',tight=None)
