    ...
    for j in naive_type:
    	...
    	for k in olr:
    		...
    		for l in lyr:
    			...
    			if (lyr_l == '30cm_100cm'):
    				CFSR_layer = "Soil_Temp_30cm_100cm"
    				CFSR2_layer = "Soil_Temp_30cm_100cm"
    				GLDAS_layer = "Soil_Temp_30cm_100cm"
    				GLDAS_CLSM_layer = "Soil_Temp_30cm_100cm"
    				ERA5_layer = "Soil_Temp_30cm_100cm"
    				ERA5_Land_layer = "Soil_Temp_30cm_100cm"
    				ERAI_layer = "Soil_Temp_30cm_100cm"
    				JRA_layer = "Soil_Temp_30cm_100cm"
    				MERRA2_layer = "Soil_Temp_30cm_100cm"
    				Naive_layer = "Soil_Temp_30cm_100cm"

    				in_situ_layer = '30_99.9'

    			if (lyr_l == '100cm_300cm'):
    				CFSR_layer = "Soil_Temp_100cm_300cm"
    				CFSR2_layer = "Soil_Temp_100cm_300cm"
    				GLDAS_layer = "Soil_Temp_100cm_300cm"
    				GLDAS_CLSM_layer = "Soil_Temp_100cm_300cm"
    				ERA5_layer = "Soil_Temp_100cm_300cm"
    				ERA5_Land_layer = "Soil_Temp_100cm_300cm"
    				ERAI_layer = "Soil_Temp_100cm_300cm"
    				JRA_layer = "Soil_Temp_100cm_300cm"
    				MERRA2_layer = "Soil_Temp_100cm_300cm"
    				Naive_layer = "Soil_Temp_100cm_300cm"

    				in_situ_layer = '100_299.9'
...
#################### grab collocated temperature data from reanalysis files #######################
    						...
    						for n in range(0,len(DateTime)):
    							...
    							naive_noJRAold_temp_master.append(naive_noJRA_temp_dt)
    						...
    						naive_noJRAold_temp_master = np.array(naive_noJRA_temp_master)
...
########################### Create Scatterplot Dataframe ############################
    					...
    					scatterplot_master_naive_noJRA = [i for sub in scatterplot_master_naive_noJRAold for i in sub]
    					...
    					scatter_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_ERA5_'+str(temp_thr_o)+'.csv'])
