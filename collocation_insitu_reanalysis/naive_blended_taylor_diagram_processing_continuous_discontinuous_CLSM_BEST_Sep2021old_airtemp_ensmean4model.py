...
for i in rmp_type:
    ...
    for j in naive_type:
    	...
    	ensmean_4_fi = ''.join([naive_dir_raw+'ensmean_4model.nc'])
    	ensmean_4_fi_air = ''.join([air_dir+'ensmean_4model_2m_air.nc'])
    	for k in olr:
    		olr_k = k
...
##### Create Master Arrays #####
    					...
    					ensmean_4_data_master_cold_temp = []
    					...
    					ensmean_4_data_master_warm_temp = []
    					...
    					ensmean_4_data_air_master_cold_temp = []
    					...
    					ensmean_4_data_air_master_warm_temp = []
...
################# loop through in-situ files ###############
    					...
    					for path in pathlist_sorted:
    						...
    						ensmean_4_fil = xr.open_dataset(ensmean_4_fi)
    						ensmean_4_fil_air = xr.open_dataset(ensmean_4_fi_air)

    						ensmean_4_stemp = ensmean_4_fil[Naive_layer]-273.15

    						naive_air_all = naive_fil_all_air[air_temp]
    						ensmean_4_air = ensmean_4_fil_air[air_temp]
    						...
    						ensmean_4_stemp_gcell = ensmean_4_stemp.sel(lat=lat_cen,lon=lon_cen,method='nearest',drop = True)
    						...
    						ensmean_4_air_gcell = ensmean_4_air.sel(lat=lat_cen,lon=lon_cen,method='nearest',drop = True)
    						#print(JRA_air_gcell)
...
#################### grab collocated temperature data from reanalysis files #######################
    						...
    						ensmean_4_temp_master = []
    						ensmean_4_air_master = []
    						station_temp_master = []
    						station_anom_master = []
    						date_temp_master = []
    						...
    						for n in range(0,len(DateTime)):
    							...
    							ensmean_4_temp_dt = ensmean_4_stemp_gcell.sel(time=DateTime_m).values.tolist()
    							ensmean_4_air_dt = ensmean_4_air_gcell.sel(time=DateTime_m).values.tolist()
    							#print(DateTime_m)
    							#print(rnys_edate_dt)
    							...
    							if(str(ensmean_4_temp_dt) == "nan"):
    								ensmean_4_temp_dt = np.nan
    							if(str(ensmean_4_air_dt) == "nan"):
    								ensmean_4_air_dt = np.nan  						
    							...
    							ensmean_4_temp_master.append(ensmean_4_temp_dt)
    							ensmean_4_air_master.append(ensmean_4_air_dt)
    						...
    						ensmean_4_temp_master = np.array(ensmean_4_temp_master)
    						ensmean_4_air_master = np.array(ensmean_4_air_master)
...
###### Cold Season (Soil Temp <= -2) #####
    						...
    						for x in cold_idx:
    							...
    							ensmean_4_x = ensmean_4_temp_master[x].tolist()
    							ensmean_4_temp_cold_season.append(ensmean_4_x)
    							...
    							ensmean_4_air_air_x = ensmean_4_air_master[x].tolist()
    							ensmean_4_air_cold_season.append(ensmean_4_air_air_x)
    						...
    						dframe_cold_season_temp['Ensemble Mean 4 Model'] = ensmean_4_temp_cold_season
    						...
    						dframe_cold_season_temp['Ensemble Mean 4 Model Air Temp'] = ensmean_4_air_cold_season
...
###### warm Season (Soil Temp <= -2) #####
    						...
    						for x in warm_idx:
    							...
    							ensmean_4_x = ensmean_4_temp_master[x].tolist()
    							ensmean_4_temp_warm_season.append(ensmean_4_x)
    							CFSR_x = CFSR_temp_master[x].tolist()
    							...
    							ensmean_4_air_air_x = ensmean_4_air_master[x].tolist()
    							ensmean_4_air_warm_season.append(ensmean_4_air_air_x)
    							BEST_air_x = BEST_air_master[x].tolist()
    						...
    						dframe_warm_season_temp['Ensemble Mean 4 Model'] = ensmean_4_temp_warm_season
    						...
    						dframe_warm_season_temp['Ensemble Mean 4 Model Air Temp'] = ensmean_4_air_warm_season
...
########################### Create Scatterplot Dataframe ############################
    						...
    						ensmean_4_data_master_cold_temp.append(dframe_cold_season_temp['Ensemble Mean 4 Model'].values.tolist())
    						ensmean_4_data_master_warm_temp.append(dframe_warm_season_temp['Ensemble Mean 4 Model'].values.tolist())
    						...
    						ensmean_4_data_air_master_cold_temp.append(dframe_cold_season_temp['Ensemble Mean 4 Model Air Temp'].values.tolist())
    						ensmean_4_data_air_master_warm_temp.append(dframe_warm_season_temp['Ensemble Mean 4 Model Air Temp'].values.tolist())
    						...
    						ERAI_data_air_master_cold_temp.append(dframe_cold_season_temp['ERA-Interim Air Temp'].values.tolist())
    						ERAI_data_air_master_warm_temp.append(dframe_warm_season_temp['ERA-Interim Air Temp'].values.tolist())
    						...
    						JRA_data_air_master_cold_temp.append(dframe_cold_season_temp['JRA55 Air Temp'].values.tolist())
    						JRA_data_air_master_warm_temp.append(dframe_warm_season_temp['JRA55 Air Temp'].values.tolist())

    						MERRA2_data_air_master_cold_temp.append(dframe_cold_season_temp['MERRA2 Air Temp'].values.tolist())
    						MERRA2_data_air_master_warm_temp.append(dframe_warm_season_temp['MERRA2 Air Temp'].values.tolist())
    						...
    						GLDAS_CLSM_data_air_master_cold_temp.append(dframe_cold_season_temp['GLDAS-CLSM Air Temp'].values.tolist())
    						GLDAS_CLSM_data_air_master_warm_temp.append(dframe_warm_season_temp['GLDAS-CLSM Air Temp'].values.tolist())
    					...
    					ensmean_4_data_master_cold_temp = [i for sub in ensmean_4_data_master_cold_temp for i in sub]
    					ensmean_4_data_master_warm_temp = [i for sub in ensmean_4_data_master_warm_temp for i in sub]
    					...
    					ensmean_4_data_air_master_cold_temp = [i for sub in ensmean_4_data_air_master_cold_temp for i in sub]
    					ensmean_4_data_air_master_warm_temp = [i for sub in ensmean_4_data_air_master_warm_temp for i in sub]
    					...
    					ERAI_data_air_master_cold_temp = [i for sub in ERAI_data_air_master_cold_temp for i in sub]
    					ERAI_data_air_master_warm_temp = [i for sub in ERAI_data_air_master_warm_temp for i in sub]
    					...
    					JRA_data_air_master_cold_temp = [i for sub in JRA_data_air_master_cold_temp for i in sub]
    					JRA_data_air_master_warm_temp = [i for sub in JRA_data_air_master_warm_temp for i in sub]

    					MERRA2_data_air_master_cold_temp = [i for sub in MERRA2_data_air_master_cold_temp for i in sub]
    					MERRA2_data_air_master_warm_temp = [i for sub in MERRA2_data_air_master_warm_temp for i in sub]
    					...
    					GLDAS_CLSM_data_air_master_cold_temp = [i for sub in GLDAS_CLSM_data_air_master_cold_temp for i in sub]
    					GLDAS_CLSM_data_air_master_warm_temp = [i for sub in GLDAS_CLSM_data_air_master_warm_temp for i in sub]
    					...
    					dframe_cold_season_temp_master['Ensemble Mean 4 Model'] = ensmean_4_data_master_cold_temp					
    					...
    					dframe_cold_season_temp_master['Naive Blend All Air'] = naive_all_data_air_master_cold_temp
    					dframe_cold_season_temp_master['Ensemble Mean 4 Model Air'] = ensmean_4_data_air_master_cold_temp
    					dframe_cold_season_temp_master['BEST Air'] = BEST_data_air_master_cold_temp
    					dframe_cold_season_temp_master['CFSR Air'] = CFSR_data_air_master_cold_temp
    					dframe_cold_season_temp_master['ERA-Interim Air'] = ERAI_data_air_master_cold_temp
    					...
    					dframe_cold_season_temp_master['JRA55 Air'] = JRA_data_air_master_cold_temp
    					dframe_cold_season_temp_master['MERRA2 Air'] = MERRA2_data_air_master_cold_temp
    					dframe_cold_season_temp_master['GLDAS-Noah Air'] = GLDAS_data_air_master_cold_temp
    					dframe_cold_season_temp_master['GLDAS-CLSM Air'] = GLDAS_CLSM_data_air_master_cold_temp
    					...
    					dframe_warm_season_temp_master['Ensemble Mean 4 Model'] = ensmean_4_data_master_warm_temp					
    					...
    					dframe_warm_season_temp_master['Naive Blend All Air'] = naive_all_data_air_master_warm_temp
    					dframe_warm_season_temp_master['Ensemble Mean 4 Model Air'] = ensmean_4_data_air_master_warm_temp
    					dframe_warm_season_temp_master['BEST Air'] = BEST_data_air_master_warm_temp
    					dframe_warm_season_temp_master['CFSR Air'] = CFSR_data_air_master_warm_temp
    					dframe_warm_season_temp_master['ERA-Interim Air'] = ERAI_data_air_master_warm_temp
    					...
    					dframe_warm_season_temp_master['JRA55 Air'] = JRA_data_air_master_warm_temp
    					dframe_warm_season_temp_master['MERRA2 Air'] = MERRA2_data_air_master_warm_temp
    					dframe_warm_season_temp_master['GLDAS-Noah Air'] = GLDAS_data_air_master_warm_temp
    					dframe_warm_season_temp_master['GLDAS-CLSM Air'] = GLDAS_CLSM_data_air_master_warm_temp
    					...
    					cold_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_cold_season_temp_master_BEST_'+str(temp_thr_o)+'_CMOS_CLSM_subset_permafrost_Sep2021_ensmean4_air.csv'])
    					dframe_cold_season_temp_master.to_csv(cold_fil,index=False)


    					warm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_warm_season_temp_master_BEST_'+str(temp_thr_o)+'_CMOS_CLSM_subset_permafrost_Sep2021_ensmean4_air.csv'])
    					...
    					scatterplot_master_ensmean_4_air = []
    					...
    					scatterplot_master_ensmean_4.append(dframe_cold_season_temp_master['Ensemble Mean 4 Model'].values.tolist())
    					scatterplot_master_ensmean_4.append(dframe_warm_season_temp_master['Ensemble Mean 4 Model'].values.tolist())
    					...
    					scatterplot_master_naive_all_air.append(dframe_cold_season_temp_master['Naive Blend All Air'].values.tolist())
    					scatterplot_master_naive_all_air.append(dframe_warm_season_temp_master['Naive Blend All Air'].values.tolist())
    					scatterplot_master_ensmean_4_air.append(dframe_cold_season_temp_master['Ensemble Mean 4 Model Air'].values.tolist())
    					scatterplot_master_ensmean_4_air.append(dframe_warm_season_temp_master['Ensemble Mean 4 Model Air'].values.tolist())
    					scatterplot_master_BEST_air.append(dframe_cold_season_temp_master['BEST Air'].values.tolist())
    					scatterplot_master_BEST_air.append(dframe_warm_season_temp_master['BEST Air'].values.tolist())
    					...
    					scatterplot_master_ERAI_air.append(dframe_cold_season_temp_master['ERA-Interim Air'].values.tolist())
    					scatterplot_master_ERAI_air.append(dframe_warm_season_temp_master['ERA-Interim Air'].values.tolist())
    					...
    					scatterplot_master_JRA_air.append(dframe_cold_season_temp_master['JRA55 Air'].values.tolist())
    					scatterplot_master_JRA_air.append(dframe_warm_season_temp_master['JRA55 Air'].values.tolist())
    					scatterplot_master_MERRA2_air.append(dframe_cold_season_temp_master['MERRA2 Air'].values.tolist())
    					scatterplot_master_MERRA2_air.append(dframe_warm_season_temp_master['MERRA2 Air'].values.tolist())
    					...
    					scatterplot_master_GLDAS_CLSM_air.append(dframe_cold_season_temp_master['GLDAS-CLSM Air'].values.tolist())
    					scatterplot_master_GLDAS_CLSM_air.append(dframe_warm_season_temp_master['GLDAS-CLSM Air'].values.tolist())
    					...
    					scatterplot_master_ensmean_4 = [i for sub in scatterplot_master_ensmean_4 for i in sub]
    					...
    					scatterplot_master_ensmean_4_air = [i for sub in scatterplot_master_ensmean_4_air for i in sub]
    					...
    					scatterplot_master_ERAI_air = [i for sub in scatterplot_master_ERAI_air for i in sub]
    					...
    					scatterplot_master_JRA_air = [i for sub in scatterplot_master_JRA_air for i in sub]
    					scatterplot_master_MERRA2_air = [i for sub in scatterplot_master_MERRA2_air for i in sub]
    					scatterplot_master_GLDAS_air = [i for sub in scatterplot_master_GLDAS_air for i in sub]
    					scatterplot_master_GLDAS_CLSM_air = [i for sub in scatterplot_master_GLDAS_CLSM_air for i in sub]
    					...
    					dframe_scatterplot_master['Ensemble Mean 4 Model'] = scatterplot_master_ensmean_4
    					...
    					dframe_scatterplot_master['Naive Blend All Air'] = scatterplot_master_naive_all_air
    					dframe_scatterplot_master['Ensemble Mean 4 Model Air'] = scatterplot_master_ensmean_4_air
    					dframe_scatterplot_master['BEST Air'] = scatterplot_master_BEST_air
    					dframe_scatterplot_master['CFSR Air'] = scatterplot_master_CFSR_air
    					dframe_scatterplot_master['ERA-Interim Air'] = scatterplot_master_ERAI_air
    					...
    					dframe_scatterplot_master['JRA55 Air'] = scatterplot_master_JRA_air
    					dframe_scatterplot_master['MERRA2 Air'] = scatterplot_master_MERRA2_air
    					dframe_scatterplot_master['GLDAS-Noah Air'] = scatterplot_master_GLDAS_air
    					dframe_scatterplot_master['GLDAS-CLSM Air'] = scatterplot_master_GLDAS_CLSM_air
    					...
    					scatter_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_BEST_'+str(temp_thr_o)+'_CMOS_CLSM_subset_permafrost_Sep2021_ensmean4_air.csv'])
