    	...
    	for k in olr:
    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				scatter_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm.csv'])
...
############ create temperature arrays ################
    				...
    				stdev_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_stdev_temp/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_stdev_temp_4_degree_bins_CMOS_CLSM_noGreenland.csv'])
...
############## Create Figure ##############
    ...
    top_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_stdev_temp/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_simple_average_zscore_top_30cm_thr_100_stdev_temp_4_degree_bins_CMOS_CLSM_noGreenland.csv'])   				
    btm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_stdev_temp/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_simple_average_zscore_30cm_300cm_thr_100_stdev_temp_4_degree_bins_CMOS_CLSM_noGreenland.csv'])
    ...
    ax1.plot(top_temp,top_naive_all_stdev,label='Ensemble Mean',marker='p',markerfacecolor='hotpink',markersize=4.0,color='hotpink',linewidth=4.0)
    ...
    ax1.plot(top_temp,top_CFSR_stdev,label='CFSR',marker='s',markerfacecolor='darkviolet',markersize=2.0,color='darkviolet',linewidth=2.0)
    ax1.plot(top_temp,top_ERAI_stdev,label="ERA-Interim",marker='v',markerfacecolor='springgreen',markersize=2.0,color='springgreen',linewidth=2.0)
    ax1.plot(top_temp,top_ERA5_stdev,label="ERA5",marker='^',markerfacecolor='greenyellow',markersize=2.0,color='greenyellow',linewidth=2.0)
    ax1.plot(top_temp,top_ERA5_Land_stdev,label="ERA5-Land",marker='^',markerfacecolor='dodgerblue',markersize=2.0,color='dodgerblue',linewidth=2.0) 
    ...
    ax3.plot(btm_temp,btm_naive_all_stdev,label='Ensemble Mean',marker='p',markerfacecolor='hotpink',markersize=4.0,color='hotpink',linewidth=4.0)
    ...
    ax3.plot(btm_temp,btm_CFSR_stdev,label='CFSR',marker='s',markerfacecolor='darkviolet',markersize=2.0,color='darkviolet',linewidth=2.0)
    ax3.plot(btm_temp,btm_ERAI_stdev,label="ERA-Interim",marker='v',markerfacecolor='springgreen',markersize=2.0,color='springgreen',linewidth=2.0)
    ax3.plot(btm_temp,btm_ERA5_stdev,label="ERA5",marker='^',markerfacecolor='greenyellow',markersize=2.0,color='greenyellow',linewidth=2.0)
    ax3.plot(btm_temp,btm_ERA5_Land_stdev,label="ERA5-Land",marker='^',markerfacecolor='dodgerblue',markersize=2.0,color='dodgerblue',linewidth=2.0) 
    ax3.plot(btm_temp,btm_JRA_stdev,label="JRA-55",marker='*',markerfacecolor='red',markersize=2.0,color='red',linewidth=2.0)
    ax3.plot(btm_temp,btm_MERRA2_stdev,label="MERRA2",marker='D',markerfacecolor='goldenrod',markersize=2.0,color='goldenrod',linewidth=2.0)
    ax3.plot(btm_temp,btm_GLDAS_stdev,label="GLDAS-Noah",marker='x',markerfacecolor='black',markersize=2.0,color='black',linewidth=2.0)
    ax3.plot(btm_temp,btm_GLDAS_CLSM_stdev,label="GLDAS-CLSM",marker='x',markerfacecolor='darkgrey',markersize=2.0,color='darkgrey',linewidth=2.0)
    ...
    fig_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/naive_blend_stdev_plots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_simple_average_zscore_all_layers_thr_100_stdev_temp_4_degree_bins_CMOS_2panel_CLSM_noGreenland.png'])
    plt.tight_layout()
    plt.savefig(fig_fil)
    plt.close()
