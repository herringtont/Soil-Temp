...
############ create temperature arrays ################
    					...
    					stdev_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_stdev_temp/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_stdev_temp_4_degree_bins_CMOS_CLSM_'+str(permafrost_type_o)+'_combined.csv'])
...
############## Create Figure ##############
    ...
    for z in permafrost_type:
    	...
    	top_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_stdev_temp/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_simple_average_zscore_top_30cm_thr_100_stdev_temp_4_degree_bins_CMOS_CLSM_'+str(permafrost_type_z)+'_combined.csv'])   				
    	btm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_stdev_temp/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_simple_average_zscore_30cm_300cm_thr_100_stdev_temp_4_degree_bins_CMOS_CLSM_'+str(permafrost_type_z)+'_combined.csv'])
    	...
    	fig_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/naive_blend_stdev_plots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_all_layers_thr_100_stdev_temp_4_degree_bins_CLSM_'+str(permafrost_type_z)+'_combined.png'])
    	plt.tight_layout()
    	plt.savefig(fig_fil)
    	plt.close()
