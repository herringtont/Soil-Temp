    	...
    	for k in olr:
    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				scatter_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_taylor_metrics/new_data/CLSM_res/subset/sites_1yr/'+str(remap_type)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_dframe_scatterplot_CMOS_CLSM_subset_permafrost_cold_warm_BEST_Sep2021_NWT_sites_1yr.csv'])
...
############ create temperature arrays ################
    				...
    				stdev_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_stdev_temp/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_thr_'+str(thr_m)+'_stdev_temp_4_degree_bins_CMOS_CLSM_noGreenland_BEST_Sep2021_NWT_sites_1yr.csv'])
...
############## Create Figure ##############
    ...
    top_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_stdev_temp/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_simple_average_zscore_top_30cm_thr_100_stdev_temp_4_degree_bins_CMOS_CLSM_noGreenland_BEST_Sep2021_NWT_sites_1yr.csv'])   				
    btm_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_stdev_temp/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_simple_average_zscore_30cm_300cm_thr_100_stdev_temp_4_degree_bins_CMOS_CLSM_noGreenland_BEST_Sep2021_NWT_sites_1yr.csv'])
    ...
    fig_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/naive_blend_stdev_plots/new_data/CMOS_poster/CLSM_res/'+str(remap_type)+'_all_layers_thr_100_stdev_temp_4_degree_bins_CMOS_2panel_CLSM_noGreenland_BEST_Sep2021_NWT_sites_1yr.png'])
    plt.tight_layout()
    plt.savefig(fig_fil)
    plt.close()
