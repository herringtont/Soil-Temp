    	...
    	for k in olr:
    		...
    		for l in lyr:
    			...
    			for m in thr:
    				...
    				timeseries_fil = ''.join([timeseries_dir+str(remap_type)+'_'+str(naive_type_j)+'_'+str(olr_k)+'_'+str(lyr_l)+'_'+str(thr_m)+'_data_CMOS_CLSM_subset.csv'])
    				...
    				summary_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/'+str(remap_type)+'_'+str(lyr_l)+'_thr'+str(thr_m)+'_gcell_summary_CLSM_subset.csv'])
    				print("Summary File:",summary_fil)
    				dframe_master.to_csv(summary_fil,index=False)  

#################### Create Extended Summary File ###################

val_stn_fil_top30 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_top_30cm_thr100_gcell_summary_CLSM_subset.csv'])
val_stn_fil_30_300 =''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_30cm_300cm_thr100_gcell_summary_CLSM_subset.csv'])
...
#print(sites_2yr_top30)
#print(sites_2yr_30_300)
######## top 30cm layer #######
...
top30_ofil = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/extended_summary/CLSM_res/remapcon_top_30cm_thr100_gcell_extended_summary_subset.csv'])
print(top30_ofil)
...
ofil_30_300 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/extended_summary/CLSM_res/remapcon_simple_average_zscore_30cm_300cm_thr100_gcell_extended_summary_subset.csv'])
