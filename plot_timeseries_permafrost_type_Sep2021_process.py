...
################# Timeseries Master Arrays #################
    		...
    		lat_master_timeseries_cold = []
    		lon_master_timeseries_cold = []
    		...
    		lat_master_timeseries_warm = []
    		lon_master_timeseries_warm = []
...
########################### Create Final Timeseries #################################
    						...
    						lat_master_timeseries_cold.append(dframe_cold_season_temp['Lat'])
    						lon_master_timeseries_cold.append(dframe_cold_season_temp['Lon'])
    						...
    						lat_master_timeseries_warm.append(dframe_warm_season_temp['Lat'])
    						lon_master_timeseries_warm.append(dframe_warm_season_temp['Lon'])
...
lat_master_timeseries_cold = [i for sub in lat_master_timeseries_cold for i in sub]
lon_master_timeseries_cold = [i for sub in lon_master_timeseries_cold for i in sub]
...
ERA5_Land_master_timeseries_cold = [i for sub in ERA5_Land_master_timeseries_cold for i in sub]
...
df_timeseries_cold['Lat'] = lat_master_timeseries_cold
df_timeseries_cold['Lon'] = lon_master_timeseries_cold
...
df_timeseries_cold['CFSR'] = CFSR_master_timeseries_cold
...
df_timeseries_cold['ERA5-Land'] = ERA5_Land_master_timeseries_cold
...
df_timeseries_cold['CFSR Air Temp'] = CFSR_air_master_timeseries_cold
...
lat_master_timeseries_warm = [i for sub in lat_master_timeseries_warm for i in sub]
lon_master_timeseries_warm = [i for sub in lon_master_timeseries_warm for i in sub]
...
ERA5_Land_master_timeseries_warm = [i for sub in ERA5_Land_master_timeseries_warm for i in sub]
...
df_timeseries_warm['Lat'] = lat_master_timeseries_warm
df_timeseries_warm['Lon'] = lon_master_timeseries_warm
...
df_timeseries_warm['CFSR'] = CFSR_master_timeseries_warm
...
df_timeseries_warm['ERA5'] = ERA5_Land_master_timeseries_warm
df_timeseries_warm['ERA5-Land'] = ERA5_master_timeseries_warm
...
df_timeseries_warm['CFSR Air Temp'] = CFSR_air_master_timeseries_warm
