...
############# loop through missing threshold ##########    	
    		for k in thr:
    			thrk = k
    			two_year_fil = "".join(["/mnt/data/users/herringtont/soil_temp/sites_1yr/CLSM/sites_1yr_",olri,"_",lyrj,"_",thrk,".csv"])
    			#print(two_year_fil)
...
################## do the spatial averaging ###################
    				if(len(dframe_gcell) > 4):
    					...
    					ofil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/spatial_average_1yr/remap",rmpi,"/no_outliers/",olrj,"/",lyrk,"/thr_",thrl,"/CLSM/Sep2021_NWT_Yukon/grid_",str(gcell),"_Sep2021_NWT_Yukon.csv"])
    				...
    				if(len(dframe_gcella) > 4):
    					...
    					ofila = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/spatial_average_anom_1yr/remap",rmpi,"/no_outliers/",olrj,"/",lyrk,"/thr_",thrl,"/CLSM/Sep2021_NWT_Yukon/grid_",str(gcell),"_anom_Sep2021_NWT_Yukon.csv"])
