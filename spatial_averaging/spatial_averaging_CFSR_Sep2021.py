...
############# loop through missing threshold ##########    	
    		for k in thr:
    			thrk = k
    			two_year_fil = "".join(["/mnt/data/users/herringtont/soil_temp/sites_2yr/CFSR/sites_2yr_",olri,"_",lyrj,"_",thrk,".csv"])
    			#print(two_year_fil)
...
################## do the spatial averaging ###################
    				if(len(dframe_gcell) > 4):
    					...
    					ofil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/spatial_average/remap",rmpi,"/no_outliers/",olrj,"/",lyrk,"/thr_",thrl,"/CFSR/Sep2021/grid_",str(gcell),"_Sep2021.csv"])
    				...
    				if(len(dframe_gcella) > 4):
    					...
    					ofila = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/spatial_average_anom/remap",rmpi,"/no_outliers/",olrj,"/",lyrk,"/thr_",thrl,"/CFSR/Sep2021/grid_",str(gcell),"_anom_Sep2021.csv"])
