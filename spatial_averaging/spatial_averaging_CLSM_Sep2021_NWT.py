...
################## do the spatial averaging ###################
    				if(len(dframe_gcell) > 4):
    					...
    					ofil = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/spatial_average/remap",rmpi,"/no_outliers/",olrj,"/",lyrk,"/thr_",thrl,"/CLSM/Sep2021_NWT/grid_",str(gcell),"_Sep2021_NWT.csv"])
    				...
    				if(len(dframe_gcella) > 4):
    					...
    					ofila = "".join(["/mnt/data/users/herringtont/soil_temp/In-Situ/All/spatial_average_anom/remap",rmpi,"/no_outliers/",olrj,"/",lyrk,"/thr_",thrl,"/CLSM/Sep2021_NWT/grid_",str(gcell),"_anom_Sep2021_NWT.csv"])
