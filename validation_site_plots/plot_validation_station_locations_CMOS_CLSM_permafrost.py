...
for z in permafrost_type:
    permafrost_type_z = z
    val_stn_fil_top30 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_top_30cm_thr100_gcell_summary_CLSM_'+str(permafrost_type_z)+'.csv'])
    val_stn_fil_30_300 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_30cm_300cm_thr100_gcell_summary_CLSM_'+str(permafrost_type_z)+'.csv'])
...
# make legend with dummy points
    ...
    plt.tight_layout()
    plt_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data//CLSM_res/validation_sites_remapcon_zscore_all_layers_thr100_CMOS_CLSM_'+str(permafrost_type_z)+'.png'])
    fig.savefig(plt_fil)
    plt.close()
