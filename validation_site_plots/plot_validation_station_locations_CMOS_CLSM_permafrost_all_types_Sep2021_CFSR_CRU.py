...
val_stn_fil_top30_con = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/CFSR_res/remapcon_top_30cm_thr100_gcell_summary_CFSR_RS_2002_continuous_CRU_Sep2021.csv'])
val_stn_fil_30_300_con = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/CFSR_res/remapcon_30cm_300cm_thr100_gcell_summary_CFSR_RS_2002_continuous_CRU_Sep2021.csv'])
val_stn_fil_top30_dis = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/CFSR_res/remapcon_top_30cm_thr100_gcell_summary_CFSR_RS_2002_discontinuous_CRU_Sep2021.csv'])
val_stn_fil_30_300_dis = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/CFSR_res/remapcon_30cm_300cm_thr100_gcell_summary_CFSR_RS_2002_discontinuous_CRU_Sep2021.csv'])
val_stn_fil_top30 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/CFSR_res//remapcon_top_30cm_thr100_gcell_summary_CFSR_RS_2002_none_CRU_Sep2021.csv'])
val_stn_fil_30_300 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/CFSR_res/remapcon_30cm_300cm_thr100_gcell_summary_CFSR_RS_2002_none_CRU_Sep2021.csv'])
...
plt.legend()
plt.tight_layout()
plt_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/CFSR_res/validation_sites_CFSR_CRU_Sep2021.png'])
fig.savefig(plt_fil)
plt.close()
