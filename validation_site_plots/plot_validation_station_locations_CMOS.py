...
#ax3.set_title('b) 100cm - 300cm Layer',fontsize=20)
...
plt.tight_layout()
plt_fil = "/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/validation_sites_remapcon_zscore_all_layers_thr100_CMOS_newdepth.png"
fig.savefig(plt_fil)
plt.close()
