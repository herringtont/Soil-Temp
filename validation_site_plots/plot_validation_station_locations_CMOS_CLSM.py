...
val_stn_fil_top30 = "/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_simple_average_zscore_top_30cm_thr100_gcell_summary_CLSM_noGreenland.csv"
val_stn_fil_30_300 = "/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_simple_average_zscore_30cm_300cm_thr100_gcell_summary_CLSM_noGreenland.csv"
...
size_30_300 = np.array(sites_master_30_300)
max_sites_30_300 = max(size_30_300)

print("Number of Grid Cells in top 30cm layer:",len(gcell_master_top30))
print(max_sites_top30)
print("Number of Grid Cells in 30cm - 300cm layer:",len(gcell_master_30_300))
print(max_sites_30_300)
...
GridCell1 = ax1.scatter(x1,y1,alpha=0.6,s=size_top30*60,marker='.',color='firebrick',zorder=3)
...
ax1.legend(scatterpoints=1, frameon=False, labelspacing = 1, loc = 'upper right', fontsize = 20)
...
#ax2text = []
#ax2text.append('Number of Sites: '+str(len(gcell_master_30_300)))
##ax2.legend(handles2, ax2text, loc='best', fontsize=18, fancybox=False, framealpha=0, handlelength=0, handletextpad=0)
#
##plot scatterplot
#x2,y2 = map1(lon_master_30_300,lat_master_30_300)
#GridCell2 = ax2.scatter(x2,y2,alpha=0.6,s=size_30_300*30,marker='.',color='firebrick',zorder=3)
...
#plot scatterplot
x3,y3 = map3(lon_master_30_300,lat_master_30_300)
GridCell3 = ax3.scatter(x3,y3,alpha=0.6,s=size_30_300*60,marker='.',color='firebrick',zorder=3)
#ax3.set_title('b) 30cm - 300cm Layer',fontsize=20)

# make legend with dummy points
for a in [1,3,5,7,9]:
    ax3.scatter([], [], c='firebrick', alpha=0.6, s=a*14, label=str(a) + ' sites')

ax3.legend(scatterpoints=1, frameon=False, labelspacing = 1, loc = 'upper right', fontsize = 20)

plt.tight_layout()
plt_fil = "/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data//CLSM_res/validation_sites_remapcon_zscore_all_layers_thr100_CMOS_CLSM_noGreenland.png"
fig.savefig(plt_fil)
plt.close()
