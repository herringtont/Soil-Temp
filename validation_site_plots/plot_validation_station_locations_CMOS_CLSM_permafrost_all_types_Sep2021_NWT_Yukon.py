...
val_stn_fil_top30_con = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_top_30cm_thr100_gcell_summary_CLSM_RS_2002_continuous_BEST_Sep2021_NWT_Yukon.csv'])
val_stn_fil_30_300_con = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_30cm_300cm_thr100_gcell_summary_CLSM_RS_2002_continuous_BEST_Sep2021_NWT_Yukon.csv'])
val_stn_fil_top30_dis = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_top_30cm_thr100_gcell_summary_CLSM_RS_2002_discontinuous_BEST_Sep2021_NWT_Yukon.csv'])
val_stn_fil_30_300_dis = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_30cm_300cm_thr100_gcell_summary_CLSM_RS_2002_discontinuous_BEST_Sep2021_NWT_Yukon.csv'])
val_stn_fil_top30 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_top_30cm_thr100_gcell_summary_CLSM_RS_2002_none_BEST_Sep2021_NWT_Yukon.csv'])
val_stn_fil_30_300 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_30cm_300cm_thr100_gcell_summary_CLSM_RS_2002_none_BEST_Sep2021_NWT_Yukon.csv'])
...
plt.legend()
plt.tight_layout()
plt_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/CLSM_res/validation_sites_remapcon_zscore_all_layers_thr100_CMOS_CLSM_RS_2002_all_permafrost_types_top30_BEST_Sep2021_NWT_Yukon.png'])
fig.savefig(plt_fil)
plt.close()
