...
val_stn_fil_top30_con = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_top_30cm_thr100_gcell_summary_CLSM_RS_2002_continuous_BEST_Sep2021.csv'])
val_stn_fil_30_300_con = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_30cm_300cm_thr100_gcell_summary_CLSM_RS_2002_continuous_BEST_Sep2021.csv'])
val_stn_fil_top30_dis = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_top_30cm_thr100_gcell_summary_CLSM_RS_2002_discontinuous_BEST_Sep2021.csv'])
val_stn_fil_30_300_dis = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_30cm_300cm_thr100_gcell_summary_CLSM_RS_2002_discontinuous_BEST_Sep2021.csv'])
val_stn_fil_top30 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_top_30cm_thr100_gcell_summary_CLSM_RS_2002_none_BEST_Sep2021.csv'])
val_stn_fil_30_300 = ''.join(['/mnt/data/users/herringtont/soil_temp/naive_blend_timeseries/summary_fil/new_data/CLSM_res/remapcon_30cm_300cm_thr100_gcell_summary_CLSM_RS_2002_none_BEST_Sep2021.csv'])
...
dframe_con_top = pd.DataFrame(data=gcell_master_top30_con,columns=['Grid Cell'])
dframe_con_top['Lat'] = lat_master_top30_con
dframe_con_top['Lon'] = lon_master_top30_con

dframe_dis_top = pd.DataFrame(data=gcell_master_top30_dis,columns=['Grid Cell'])
dframe_dis_top['Lat'] = lat_master_top30_dis
dframe_dis_top['Lon'] = lon_master_top30_dis

dframe_none_top = pd.DataFrame(data=gcell_master_top30,columns=['Grid Cell'])
dframe_none_top['Lat'] = lat_master_top30
dframe_none_top['Lon'] = lon_master_top30
...
for i, (x,y) in enumerate(zip(x1,y1)):
    gcell_z = z1[i]
    lat_z = lat_master_top30[i]
    lon_z = lon_master_top30[i]

    if (gcell_z == 2360 or gcell_z == 2959 or gcell_z == 3107 or gcell_z == 3555 or gcell_z == 4594 or gcell_z == 6230 or gcell_z == 7424 or gcell_z == 16963):
    	print(gcell_z,lat_z,lon_z)
    	if (gcell_z == 2360):
    		letter = 'A'
    	elif (gcell_z == 2959):
    		letter = 'B'
    	...
    	print(letter)    
    	ax1.annotate(str(letter), (x,y), xytext=(5,5), textcoords='offset points')

for j, (x,y) in enumerate(zip(x2,y2)):
    gcell_z = z2[j]
    lat_z = lat_master_top30_dis[j]
    lon_z = lon_master_top30_dis[j]
...
for k, (x,y) in enumerate(zip(x3,y3)):
    gcell_z = z3[k]
    lat_z = lat_master_top30_con[k]
    lon_z = lon_master_top30_con[k]
...
plt.tight_layout()
plt_fil = ''.join(['/mnt/data/users/herringtont/soil_temp/plots/validation_sites/new_data/CLSM_res/validation_sites_remapcon_zscore_all_layers_thr100_CMOS_CLSM_RS_2002_all_permafrost_types_top30_BEST_Sep2021_letter.png'])
fig.savefig(plt_fil)
plt.close()
